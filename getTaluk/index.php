...
$sql = "SELECT 
    (SELECT district_name FROM district_name WHERE district_name.unique_id = taluk_creation.district_name) as districtName,
    taluk_name as talukName
    FROM taluk_creation WHERE is_delete = 0";
...
if ($result->num_rows > 0) {
    ...
    echo json_encode(["status" => "Success", "data" => $talukData]);
} else {
