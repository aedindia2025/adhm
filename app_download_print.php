    ...
    if ($_GET["unique_id"]) {
	    ...
	    "age",
            ...
            "std_app_no",
            "entry_date",
            "(select academic_year from std_app_s where std_app_s.unique_id = $table.s1_unique_id) as academic_year",
            "(select applied_date from batch_creation where batch_creation.s1_unique_id = $table.s1_unique_id)as applied_date",
            "(select hostel_name from batch_creation where batch_creation.s1_unique_id = $table.s1_unique_id)as std_hostel_name",
            "(select hostel_district from batch_creation where batch_creation.s1_unique_id = $table.s1_unique_id)as std_hostel_district",
            "(select hostel_taluk from batch_creation where batch_creation.s1_unique_id = $table.s1_unique_id)as std_hostel_taluk",
            "(select mother_name from std_app_s6 where std_app_s6.s1_unique_id = $table.s1_unique_id)as std_mother_name",
            "(select father_qual from std_app_s6 where std_app_s6.s1_unique_id = $table.s1_unique_id)as std_father_qual",
            "(select mother_qual from std_app_s6 where std_app_s6.s1_unique_id = $table.s1_unique_id)as std_mother_qual",
            "(select father_occu from std_app_s6 where std_app_s6.s1_unique_id = $table.s1_unique_id)as std_father_occu",
            "(select mother_occu from std_app_s6 where std_app_s6.s1_unique_id = $table.s1_unique_id)as std_mother_occu",
            "(select single_parent from std_app_s6 where std_app_s6.s1_unique_id = $table.s1_unique_id)as std_single_parent",
            "address",
            "unique_id",
...
$stdu_age   = $result_values[0]["age"];
           ...
           $stdu_father_name   = $result_values[0]["father_name"];
            ...
            // if ($std_application_tpe == 1) {
            //     $std_application_tpe = 'Fresher';
            // } elseif ($std_application_tpe == 2) {
            //     $std_application_tpe = 'Renewal';
            // }
        ...
        if ($result_values2->status) {
            ...
            $i_father_name        = $result_values2[0]["i_father_name"];
    ...
    // $diffabled             = $result_values_s6[0]["diffabled"];
        ...
        $std_door_no_s6        = $result_values_s6[0]["door_no"];
        $std_block_s6        = $result_values_s6[0]["block"];
        $std_street_name_s6        = $result_values_s6[0]["street_name"];
        $std_area_name_s6        = $result_values_s6[0]["area_name"];
        $std_district_s6        = $result_values_s6[0]["district"];
        $std_pincode_s6        = $result_values_s6[0]["pincode"];
        $std_guardian_no_s6        = $result_values_s6[0]["guardian_no"];

        $pr_address = $std_door_no_s6.', '.$std_block_s6.', '.$std_street_name_s6.', '.$std_area_name_s6.', '.$std_district_s6.', '.$std_pincode_s6;
    ...
    <div class="card-body">
        <div class="clearfix">
            <div class=" mb-3 mt-1 text-center vendorListHeading2">
                <img src="assets/images/ad-logo.png" alt="dark logo" height="70">
            </div>
        ...
        <div class="row">
                ...
                <div class="mt-0 float-sm-left">
                    <div class="row">
                        <div class="col-sm-9">
                            <div class="row">
                                <div class="col-sm-5 ">
                                    <p class="font-12">Student Name: <strong><?= $stduent_name; ?></strong></p>
                                </div>
                                ...
                                <div class="col-sm-5">
                                    <p class="font-12">Mobile Number: <strong><?= $mobile_no; ?></strong></p>
                                </div>
                                <div class="col-sm-6 first-section-sec-col">
            ...
            <div class="col-sm-12 ">
                <div class="mt-0 float-sm-left">
                    ...
                    $where = "s1_unique_id = '".$unique_id."' and is_delete = '0' order by priority asc";
$table      =  "std_app_s7";
...
$result_values  = $pdo->select($table_details, $where);
if ($result_values->status) {
    $res_array = $result_values->data;
    foreach ($res_array as $key => $value) {

                    ?>
                    <div class="row">
                        <div class="col-sm-4">
                            <p class="font-12">Priority: <strong><?php echo $value['priority'];?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Hostel District: <strong><?= district_name($value['hostel_district'])[0]['district_name']; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Hostel Taluk: <strong><?= taluk_name($value['hostel_taluk'])[0]['taluk_name']; ?></strong></p>
                        </div>
                       
                        <div class="col-sm-4">
                            <p class="font-12">Hostel Name: <strong><?= hostel_name($value['hostel_name'])[0]['hostel_name']; ?></strong></p>
                        </div>
                    </div>
                    <hr>
                    <?php }
            ...
            <div class="col-sm-12 ">
                <div class="mt-0 float-sm-left">
                    <div class="row">
                        ...
                        <?php } ?>
                        <div class="col-sm-4">
                            <p class="font-12"> D.O.B: <strong><?= disdate($student_dob_s6); ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12"> Age: <strong><?= $student_age_s6; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Blood Group: <strong><?= $student_blood_group_s6; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Gender : <strong><?= $std_gender; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12"> Email Id : <strong><?= $std_email_id_s6; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Religion : <strong><?= $std_religion_s6; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Mother Tongue : <strong><?= $std_mother_tongue_s6; ?></strong></p>
                        </div>
                        <!-- <div class="col-sm-4">
                            <p class="font-12">Community Certificate No : <strong><?= $caste_no; ?></strong></p>
                        </div> -->
                        <?php //if ($std_orphan == 'NO') { ?>
                            <div class="col-sm-4">
                                <p class="font-12">Father Name: <strong><?= $std_father_name_s6; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">Mother Name: <strong><?= $std_mother_name; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">Father Qualification: <strong><?= $std_father_qual; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">Mother Qualification: <strong><?= $std_mother_qual; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">Father Occupation: <strong><?= $std_father_occu; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">Mother Occupation: <strong><?= $std_mother_occu; ?></strong></p>
                            </div>
                        <?php  // } ?>

                      
                        <div class="col-sm-4">
                            <p class="font-12"> Parent Number : <strong><?= $std_father_num_s6; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12"> Guardian Number : <strong><?= $std_guardian_no_s6; ?></strong></p>
                        </div>
				...
				<p class="font-12"> Remarks :  <strong><?= $remarks; ?></strong></p>
                        ...
                        <div class="col-sm-4">
                            <p class="font-12"> Physically challenged : <strong><?= $diffabled; ?></strong></p>
                        </div>
                        <?php if ($diffabled == 'Yes') { ?>
                            ...
                            <div class="col-sm-4">
                                <p class="font-12"> Challenged Category : <strong><?= $diffabled_categ; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12"> Challenged Percentage : <strong><?= $diffabled_percent; ?></strong></p>
                            </div>
                        <?php } ?>
                        <div class="col-sm-4">
                            <p class="font-12"> Srilankan Refugees: <strong><?= $std_refugee_s6; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Orphanages: <strong><?= $std_orphan_s6; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <p class="font-12">First Graduate: <strong><?= $std_first_graduate_s6; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Present Address: <strong><?= $pr_address; ?></strong></p>
                        </div>
                    </div>
                </div><!-- end col -->
            </div>
            ...
            <div class="col-sm-12 ">
                <div class="mt-0 float-sm-left">
                    <div class="row">
                        <?php if ($student_type == "65f00a259436412348") { ?>
                            ...
                            <!-- student_school_name -->
                            <div class="col-sm-4">
                                <p class="font-12"> Class : <strong><?= $student_class ?></strong></p>
                            </div>
                            ...
                            <div class="col-sm-4">
                                <p class="font-12">Medium : <strong><?= $student_medium; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">School District: <strong><?= $student_school_district; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">School Block: <strong><?= $student_school_block ?></strong></p>
                            </div>
                    </div>
                <?php } else { ?>
                    <div class="col-sm-12">
                        <p class="font-12">UMIS / No UMIS: <strong><?php echo $umis_admission_type ; ?></strong></p>
                    </div><br>
                    <?php
                    if($clg_umis_no != ""){
                        ?>
              ...
              <?php } else { ?>
               ...
               <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        <p class="font-12">Studying year: <strong><?php echo $student_studying_year;?> Year </strong></p>
                    </div>
                    <!-- medium_type($clg_std_medium)[0]['medium_type'] -->
                    <div class="col-sm-4">
        ...
        <!-- <?php if ($hostel_type != "65f00a259436412348") { ?>
											<div class="col-sm-12 ">
												...
												<div class="row">
												<div class="col-sm-4">
                                                <?= school_name($last_std_scl_name)[0]['school_name']; ?>
    ...
    <div class="col-sm-12 mb-2 ">
        <div class="mt-0 float-sm-left">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <p class="font-12">Full Name : <strong><?= $community_student_name; ?></strong></p>
                </div>
                <div class="col-sm-4">
                    <p class="font-12">Caste Name : <strong><?= $caste_name; ?></strong></p>
                </div>

                <div class="col-sm-4">
                    <p class="font-12"> Sub Caste Name : <strong><?= $sub_caste_name; ?></strong></p>
                </div>
                <div class="col-sm-4">
                ...
                <?php if ($community_files) { ?>
                    ...
                    <p class="font-12"> Community Certificate: <strong><?= $std_community_files; ?></strong></p>
                    <?php } else { ?>

                    <p class="font-12"> Community Certificate: <strong><a href="<?= $community_pdf; ?>"><img src="assets/images/pdf.png" width="50px"></a></strong></p>

                    <?php  } ?>

                    <!-- <p class="font-12"> Community Certificate: <strong><a href="<?=$community_pdf;?>"><img src="../../assets/images/pdf.png" width="50px" height="50px"></a></strong></p> -->
                </div>
                <div class="col-sm-4">
                    <p class="font-12">Father Name : <strong><?= $c_father_name; ?></strong></p>
                </div>
                <div class="col-sm-4">
                    <p class="font-12">Mother Name : <strong><?= $i_mother_name; ?></strong></p>
                </div>

            </div>
            <!-- income-certificate -->
            <div class=" mt-1 vendorListHeading">
            <p><b>Income Certificate</b></p>
            ...
            <div class="row">
                ...
                <div class="col-sm-4 mt-2">
                    <b>
                        <p class="font-12"> Income Certificate No : <strong><?= $income_no; ?></strong></p>
                    </b>
                </div>
            </div>
            <div class="row mb-2">
                <div class="col-sm-4">
                    <p class="font-12">Full Name : <strong><?= $income_student_name; ?></strong></p>
                </div>
                <div class="col-sm-4">
                    <p class="font-12"> Father Income Source: <strong><?= $father_income_source; ?></strong></p>
                </div>
                <div class="col-sm-4">
                    <p class="font-12">Mother Income Source: <strong><?= $mother_income_source; ?></strong></p>
                </div>
                <div class="col-sm-4">
                    <p class="font-12">Income Level: <strong><?= $income_level; ?></strong></p>
                </div>
                <div class="col-sm-4">
                    <p class="font-12">Father Name : <strong><?= $i_father_name; ?></strong></p>
                </div>
                <div class="col-sm-4">
                    <p class="font-12">Mother Name: <strong><?= $i_mother_name; ?></strong></p>
                </div>
                <div class="col-sm-4 ">
                    <p class="font-12"> Income Certificate: <strong><a href="<?=$income_pdf;?>"><img class="pdf-pic-spacing" src="assets/images/pdf.png"  width="50px"></a></strong></p>
                </div>
...
$image_view = "";
        if ($doc_file_name) {
            ...
            if (($cfile_name[1] == 'jpg') || ($cfile_name[1] == 'png') || ($cfile_name[1] == 'jpeg')) {
                // echo "dd";
                $image_view .= '<a href="javascript:print_view(\'/' . $doc_file_name . '\')"><img src="uploads/' . $doc_file_name . '"  width="50px" ></a>';
                // $image_view .= '<img src="uploads/'.$folder_name.'/'.$doc_name.'"  height="50px" width="50px" >';
            } else if ($cfile_name[1] == 'pdf') {
                $image_view .= '<a href="javascript:print_pdf(\'/' . $doc_file_name . '\')"><img src="assets/images/pdf.png"   width="50px" style="margin-left: 15px;" ></a>';
            }
