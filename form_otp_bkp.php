...
var fatherName = co ? co.replace(/^(S\/O|D\/O) ?:? ?/i, "").trim() : "";
							...
							var data1 = "&hostel_type=" + base64Encode(hostel_type) + "&academic_year=" + base64Encode(academic_year) + "&app_type=" + base64Encode(app_type) + "&uuid=" + base64Encode(uuid) + "&std_name=" + base64Encode(name) + "&action=createupdate";
