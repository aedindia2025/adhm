...
$institute_name = select_option($institute_name, "SELECT Institution");
				...
				<ul class="nav nav-tabs  mb-3 new-tabdesig" role="tablist">
					...
					<li class="nav-item ds" role="presentation">
						<a href="#tab35" data-bs-toggle="tab" data-toggle="tab" class="nav-link " aria-selected="false"
							tabindex="-1" role="tab" disabled onclick="hostelChoice();">
						...
						<div class="row spel-app">
							...
							<div class="col-md-6  normal-imput">
								<div class="row">
									...
									<div class="col-md-6">
										<label class="form-label" for="userName2">மாணாக்கரின் முழுப் பெயர் / Student Full Name (As per Aadhaar)</label>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<label class="form-label" for="userName2">ஆதாருடன் இணைக்கப்பட்ட மாணாக்கரின் கைப்பேசி எண்ணினை பதிவிடவும் / Enter the Student Aadhaar linked Mobile Number</label>
									</div>
									<div class="col-md-6">
									...
									<div class="">
										<div class="row spel-app">
											<div class="col-md-6 normal-imput">
												<div class="row">
													<div class="col-md-6 ">
														<label class="form-label" for="userName2">தங்களின் EMIS எண்ணினை பதிவிடவும் / Enter your EMIS ID</label>
													</div>
									...
									<div class="row spel-app mt-2" id="hiddenDiv" style="display: none;">
										<div class="col-md-6 normal-imput">
											...
											<div class="row">
												...
												<div class="col-md-6">
													<label class="form-label" for="userName2"> மாணாக்கரின் முழுப் பெயர் / Student Full Name (As per EMIS)
													</label>
												</div>
												<div class="col-md-6">
													<input type="text" id="emis_name" class="form-control"
														oninput="valid_user_name(this)" value="<?= $emis_std_name; ?>" readonly>
												</div>
												...
												<div class="col-md-6">
													...
													<label class="form-label" for="userName2">மாணகக்கர் தற்பொழுது பயிலும் வகுப்பு / Student current studying standard</label>
												</div>
												<div class="col-md-6">
										...
										<div class="col-md-6  normal-imput">
											<div class="row ">
												...
												<div class="col-md-6">
													<label class="form-label" for="userName2">பள்ளியின் பெயர் / School Name</label>
												</div>
												<div class="col-md-6">
													<input type="text" id="emis_school_name" class="form-control"
														value="<?= $school_name; ?>" readonly>
												</div>
									...
									<div class="row spel-app mt-3 ">
										<div class="col-md-12 normal-imput">
											...
											<div class="row" id="yr_std_div">
												<div class="col-md-6">
													<label class="form-label" for="userName2">நீங்கள் கல்லூரியில் தற்பொழுது பயிலும் ஆண்டு? /  Which year are you currently studying in the college? </label>
												</div>
												<div class="col-md-4">
													<select class="form-select" id="yr_stdy" onchange="get_lat_div()">
														...
														<option value="1" <?php if ($year_studying == "1") {
															echo "selected";
														} ?>>முதலாம் ஆண்டு (First Year)</option>
														<option value="2" <?php if ($year_studying == "2") {
															echo "selected";
														} ?>>இரண்டாம் ஆண்டு (Second Year)</option>
														<option value="3" <?php if ($year_studying == "3") {
															echo "selected";
														} ?>>மூன்றாம் ஆண்டு (Third Year)</option>
														<option value="4" <?php if ($year_studying == "4") {
															echo "selected";
														} ?>>நான்காம் ஆண்டு (Fourth year)</option>
														<option value="5" <?php if ($year_studying == "5") {
															echo "selected";
														} ?>>ஐந்தாம் ஆண்டு (Fifth year)</option>
													</select>
												</div>
												<div class="col-md-2" id="umis_cancel" style="display: none;">
									...
									<div class="" id="havingUmis" style="display: none;">
										<div class="row spel-app mt-2">
											<div class="col-md-6 normal-imput ">
												<div class="row">
													<div class="col-md-6">
														<label class="form-label" for="userName2">தங்களின் UMIS எண்ணினை பதிவிடவும் / Enter your UMIS ID <br>
										...
										<div class="row spel-app mt-3" id="toggleUmis" style="display: none;">
											<div class="col-md-6 normal-imput">
												<div class="row">
													<div class="col-md-6">
														<label class="form-label" for="userName2">மாணாக்கரின் முழுப் பெயர் / Student Full Name ( As per UMIS )</label>
													</div>
													<div class="col-md-6">
														<input type="text" id="umis_std_name" class="form-control"
															value="<?= $umis_name; ?>" readonly>
													</div>
													<div class="col-md-6">
													...
													<div class="col-md-6">
														<input type="text" id="umis_dob" class="form-control"
															value="<?= $umis_dob; ?>" readonly>
													</div>
													<div class="col-md-6">
														<label class="form-label" for="userName2">கல்லூரியில் சேர்க்கை பெற்ற ஆண்டு / Year of Admission in college</label>
													</div>
													<div class="col-md-6">
														<input type="text" id="umis_yoa" class="form-control"
															value="<?= $umis_yoa; ?>" readonly>

													</div>
													<div class="col-md-6">
														<label class="form-label" for="userName2">படிப்பு ஆண்டு / Year of Study</label>
													</div>
													<div class="col-md-6">
												...
												<div class="row ">
													...
													<div class="col-md-6">
														<input type="text" id="umis_std_degree" class="form-control"
															value="<?= $umis_std_degree; ?>" readonly>
													</div>
													<div class="col-md-6">
													...
													<div class="col-md-6">
														<input type="text" id="umis_std_course" class="form-control"
															value="<?= $umis_std_course; ?>" readonly>
													</div>
											...
											<div class="row">
												...
												<div class="col-md-6">
													...
													<select class="form-select mb-0" id="no_umis_yoa">
														<option selected value="">Select</option>
														<option value="2025" <?php if ($no_umis_yoa == "2025") {
															echo "selected";
														} ?>>2025</option>
					...
					<div class="tab-pane" id="tab33" role="tabpanel">
						...
						<div class="row spel-app  ">
							<div class="col-md-7">
								<div class="row normal-imput">
									<div class="col-md-7">
										<label class="form-label" for="userName2">நீங்கள் எந்த வகுப்பைச் சார்ந்தவர்? / Which Community category do you belongs to ?</label>
									</div>
									<div class="col-md-5">
							...
							<div class="row" id="communityno_div" style="display:none">
								<div class="col-md-8">
									<div class="row normal-imput">
										...
										<div class="col-md-6">
											<label class="form-label" for="userName2">சாதிச் சாண்றிதழ் எண் / Community Certificate No.</label>
										</div>
										<div class="col-md-6">
											<input type="text" id="communityno" name="communityno" class="form-control"
												onkeyup="empty_com()" value="<?= $c_no; ?>" maxlength="17"
									...
									<div class="col-md-6 ">
										<div class="row normal-imput">
											...
											<div class="col-md-6 ">
												...
												<label class="form-label" for="userName2">வகுப்பு / Communal Category</label>
											</div>
											<div class="col-md-6 ">
											...
											<div class="col-md-6 ">
												...
												<label class="form-label" for="userName2">சாதி உட்பிரிவின் பெயர் / Name of the Sub-caste</label>
											</div>
											<div class="col-md-6 ">
										...
										<div class="row normal-imput">
											...
											<div class="col-md-6 ">
												<input type="text" id="fathername4" name="fathername4"
													class="form-control" oninput="valid_user_name(this)" disabled
										...
										<div class="row normal-imput">
											...
											<div class="col-md-6 ">
												<input type="text" id="fatherincomesource" name="fatherincomesource"
													class="form-control" value="<?= $f_income_source; ?>">
											</div>
							...
							<div class="col-md-6">
								<div class="row normal-imput">
									...
									<div class="col-md-6">
										...
										<label class="form-label" for="userName2">தந்தையின் கல்வி தகுதி / Father Educational Qualification</label>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<label class="form-label" for="userName2">தாயின் கல்வி தகுதி / Mother Education Qualification</label>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										...
										<label class="form-label" for="userName2">பெற்றோர்/ பாதுகாவலர் கைப்பேசி எண் / Parent/Guardian Mobile No</label>
									</div>
									<div class="col-md-6">
									...
									<div class="col-md-6">
										<label class="form-label" for="userName2">தற்போதைய முகவரி / Present Address</label>
									</div>
									<div class="col-md-6">
