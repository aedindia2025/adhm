...
<body>
    ...
    <div class="wrapper">
                ...
                <ul class="topbar-menu d-flex align-items-center gap-3">
                    ...
                    <li class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target=".bs-example-modal-md" class="dropdown-item">
                ...
                <div class="card text-center pro-mar">
                    <div class="card-body red-pad">
                        ...
                        <div class="text-start n-colo mt-1">
                            ...
                            <p class=" mb-1 font-13"><i class="   ri-user-follow-fill"></i><span class="ms-2"><?php echo $_SESSION["designation_name"];?></span></p>
                            <p class=" mb-1 font-13"><i class="  ri-cellphone-line"></i><span class="ms-2"><?php echo $_SESSION['mobile_num']; ?></span></p>

                            <p class="mb-1 font-13"><i class="uil-envelope"></i> <span class="ms-2 "><?php echo $_SESSION['email_id'];?></span></p>

                            <p class=" mb-0 font-13"><i class=" ri-user-location-line"> </i><span class="ms-2"><?php echo $_SESSION['district_address'];?></span></p>
                        </div>
        ...
        <div class="modal fade bs-example-modal-md" id="mymodel" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" role="dialog" aria-labelledby="myExtraLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    <div class="modal-header" style="background: #2999c4;color: #fff;">
                        ...
                        <button type="button" class="close"  onclick="clearPasswordFields()" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                    </div>
                                ...
                                <div class="col-md-10">
                                    <div class="mb-2">
                                        ...
                                        <div class="input-group">
                                            <input class="form-control" placeholder="enter your old password" type="password" name="old_password" id="old_password" oninput="valid_password(this)" onkeyup="verify_password()" size="30">
                                        ...
                                        <div class="mb-4 mt-3 hidden" id="new_password_section">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="password" name="new_password" id="new_password" oninput="valid_password(this)" size="30" onkeyup="password_vali()" minlength="8">
                                                <div class="input-group-text" data-password="false">
                                                    <span class="password-eye"></span>
                                        ...
                                        <div class="mb-3 hidden" id="confirm_password_section">
                                            ...
                                            <div class="input-group">
                                                <input class="form-control" type="password" name="confirm_password" id="confirm_password"  oninput="valid_password(this)" size="30">
                                                <div class="input-group-text" data-password="false">
                                                    <span class="password-eye"></span>
                                                </div>
                                                <div class="mb-3">
                                    ...
                                    <div class="btns" style="margin-right:240px">
                                        <button type="button" name="submit" id="submit" onclick="submit_password()" class="btn btn-primary">Submit</button>
                                    </div>
                        </div>
                    </div>
                    <br>
