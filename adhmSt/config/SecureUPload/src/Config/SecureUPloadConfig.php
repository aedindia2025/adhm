...
class SecureUPloadConfig extends Config
{
    ...
    protected $default_config = array(
        'storage_type' => '1',
        'file_types'   => array('jpg' => 'image/jpeg', 'jpeg' => 'image/jpeg', 'png' => 'image/png', 'gif' => 'image/gif', 'txt'=> 'text/plain'),
        'organize_by'  => 'none',
        'min_filesize' => 0,
        'max_filesize' => 0
    );
    ...
    protected $config = array(
        'upload_folder' => '',
        'storage_type'  => '1',
        'file_types'    => array('jpg' => 'image/jpeg', 'jpeg' => 'image/jpeg', 'png' => 'image/png', 'gif' => 'image/gif', 'pdf' => 'application/pdf', 'xls' => 'application/vnd.ms-excel', 'xlsx' => 'application/vnd.openxmlformats-officedocument.spreadsheetml.sheet', 'txt' => 'text/plain'),
        'organize_by'   => 'none',
        'min_filesize'  => 0,
        'max_filesize'  => 0
    );
