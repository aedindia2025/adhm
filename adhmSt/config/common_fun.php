...
function designation($unique_id = "") {
    ...
    $designation_type_list = $pdo->select($table_details, $where);

    if ($designation_type_list->status) {
        return $designation_type_list->data;
    } else {
        print_r($designation_type_list);
        return 0;
    }
}
...
function taluk_district($unique_id="") {
    global $pdo;
...
// hostel name
function hostel_names_fil($unique_id = "",$taluk_name = "") {
...
function hostel_name($unique_id = "",$taluk_id = "") {
    // echo $zone_name;
...
function academic_year($unique_id = "", $acc_year = "") {
    // echo $zone_name;
...
function sp_tahsildar_hostel_list($hostel_values = ''){
    ...
    $query = "select unique_id,hostel_name,hostel_id from hostel_name where is_delete='0' $hostel_name_options";
    // echo $query;
    ...
    $option_str .= "<option value=".$hostel_unique_id.">".$hostel_name." - ".$hostel_id."</option>";
    
    }
    return $option_str;

    // print_r($option_str);die();
