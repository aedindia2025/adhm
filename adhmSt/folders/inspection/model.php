...
$hostel_name_options   = sp_tahsildar_hostel_list($hostel_ids);


// $hostel_name_options   = select_option_host($hostel_ids);


// $hostel_name_options = hostel_name("",$ses_taluk_id);
// $hostel_name_options = select_option_host($hostel_name_options, "Select Hostel Name");
                                        ...
                                        <div class="row mb-3">
                                            <div class="col-md-6 fm">
                                                ...
                                                <div class="col-md-6 fm">
                                                    ...
                                                    <input type="hidden" class="form-control" id="district_name" name="district_name" value="<?= $ses_district_id;?>" required>
                                                    <input type="hidden" class="form-control" id="taluk_name" name="taluk_name" value="<?= $ses_taluk_id;?>" required>
                                                    <input type="hidden" class="form-control" id="inspection_id" name="inspection_id" value="<?= $inspection_id; ?>" required>
                                                </div>
                                                ...
                                                <div class="col-md-6 fm mt-3">
                                                    ...
                                                    <input type="hidden" class="form-control" id="ins_pic" name="ins_pic" value="<?= $file_name;?>" required>
                                                </div>
