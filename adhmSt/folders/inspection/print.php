...
if (isset($_GET['unique_id'])) {
    if (!empty($_GET['unique_id'])) {
        ...
        $columns = [
            ...
            // "(select staff_name from staff_registration where staff_registration.user_type='65cb092facaf836335' AND staff_registration.hostel_name = $table.hostel_name) as warden_name",
            'description',
            'file_name',
        ];
