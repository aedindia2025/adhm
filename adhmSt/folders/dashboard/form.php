        ...
        <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title" style="line-height: 18px;margin: 16px 0px;">Dashbaord</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-lg-3 col-sm-6">
                    <div class="card widget-flat text-bg-success">
                        <div class="card-body">
                            ...
                            <h3 class="mt-3 mb-3 text-reset" id="total_hostel" onclick="new_external_window_print_new(event,'folders/dashboard/hostel_print.php');">></h3>
                            <p class="mb-0">
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card widget-flat text-bg-danger ">
                        <div class="card-body">
                            ...
                            <h3 class="mt-3 mb-3 text-reset"id="total_students" onclick="new_external_window_print_new(event,'folders/dashboard/student_print.php');">>></h3>
                            <p class="mb-0">
                                <span class="badge bg-white bg-opacity-10 me-1">
                                    <i class=""></i> </span>
                                <span class="text-nowrap"></span>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="card widget-flat text-bg-primary">
                        <div class="card-body">
                            ...
                            <h3 class="mt-3 mb-3 text-reset" id="total_staff" onclick="new_external_window_print_new(event,'folders/dashboard/staff_print.php');"></h3>
                            <p class="mb-0">
                                <span class="badge bg-white bg-opacity-10 me-1">
                                    <i class=""></i></span>
                                <span class="text-nowrap"></span>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title" style="line-height: unset;margin-bottom: 14px;">Application</h4>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-body red-pad">
                                    ...
                                    <h3 class="m-0  cta-box-title text-reset">Applied Leave</h3>
                                        ...
                                        <h4 class="mt-2 mb-0 v-1 count"
                                            style="color: #fff;margin-top:10px !important;" id="no_of_student_name" onclick="new_external_window_print_new(event,'folders/dashboard/student_leave_count.php');"></h4></a>
