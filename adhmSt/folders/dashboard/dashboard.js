...
function get_total_students(){
    ...
    $.ajax({
        ...
        success:function(data)
        {
            ...
            $('#total_students').text(student_name);
        }
   });
}
...
function get_total_staff(){
    ...
    $.ajax({
        ...
        success:function(data)
        {
            ...
            $('#total_staff').text(staff_name);
        }
   });
}
function applied_leave_details()  
{
//   alert(no_of_student_name);
...
function get_holiday_details()  
    ...
    //                         notification_li += '<li class=" mb-1  psd"><p class=" mb-1 font-13"><i class="mdi mdi-calendar"></i>' + notification_data[key].date +
    //                         '</p><h5 class="'+ h5ClassName +'">'+ notification_data[key].title +'</h5></li><h5 class="'+ dClassName +'">' + notification_data[key].content +'</h5></li>';
