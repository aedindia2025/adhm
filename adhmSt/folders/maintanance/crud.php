...
switch ($action) {
    ...
    case 'datatable':
        ...
        $where = "is_delete = 0 AND hostel_taluk = ?";
        ...
        if ($result) {
            ...
            foreach ($res_array as $key => $value) {
                ...
                // For example, modifying status
                // $value['status'] = ...; // Modify status as per your requirement

                // Example modification of file_name column
                $value['file_name'] = image_view('adhmHostel', $value['unique_id'], $value['file_name']);

                // Example modification of unique_id column
        ...
        foreach ($file_names as $file_key => $doc_file_name) {
            ...
            if ($doc_file_name) {
                if (($cfile_name[1] == 'jpg') || ($cfile_name[1] == 'png') || ($cfile_name[1] == 'jpeg')) {
                    $image_view .= '<a href="javascript:print_view(\'/' . $doc_file_name . '\')"><img src="assets/images/images.png"  width="40%" ></a>';
