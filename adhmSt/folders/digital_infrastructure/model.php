                                            ...
                                            <div id="own_land_div" style="display:none;">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 fm">
                                                        ...
                                                        <input type="text" id="reg_of_land" name="reg_of_land" class="form-control" oninput="off_id(this);" value="<?php echo $reg_of_land; ?>">
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                    ...
                                                    <div class="col-md-3 fm">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="area_of_land" name="area_of_land" oninput="number_only(this)" value="<?php echo $area_of_land; ?>">
                                                    ...
                                                    <div class="col-md-3 fm">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="con_area_land" name="con_area_land" oninput="number_only(this)" value="<?php echo $con_area_land; ?>">
                                                            <span class="input-group-text">sq ft</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <div id="ground_floor_div" style="display:none">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3 fm" id="no_toilet_div">
                                                        ...
                                                        <input type="text" id="toilet_each_floor" name="toilet_each_floor" class="form-control" oninput="number_only(this)" minlength="1" maxlength="3" value="<?php echo $toilet_each_floor; ?>">
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Number of living area</label>
                                                        <input type="text" id="living_area" name="living_area" class="form-control" oninput="number_only(this)" minlength="1" maxlength="3" value="<?php echo $living_area; ?>">
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Living Area Size</label>
                                                        <div class="input-group">
                                                            <input type="text" id="living_area_size" name="living_area_size" class="form-control" oninput="number_only(this)" value="<?php echo $living_area_size; ?>">
                                                            <span class="input-group-text">sq ft</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Number of Rooms</label>
                                                        <input type="text" id="no_of_rooms" name="no_of_rooms" class="form-control" oninput="number_only(this)" minlength="1" maxlength="3" value="<?php echo $no_of_rooms; ?>">
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Room Size</label>
                                                        <div class="input-group">
                                                            <input type="text" id="room_size" name="room_size" class="form-control" oninput="number_only(this)" value="<?php echo $room_size; ?>">
                                                            <span class="input-group-text">sq ft</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Number of Kitchen</label>
                                                        <input type="text" id="no_of_kitchen" name="no_of_kitchen" class="form-control" oninput="number_only(this)" minlength="1" maxlength="3" value="<?php echo $no_of_kitchen; ?>">
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Kitchen Size</label>
                                                        <div class="input-group">
                                                            <input type="text" id="kitchen_size" name="kitchen_size" class="form-control" oninput="number_only(this)" value="<?php echo $kitchen_size; ?>">
                                                            <span class="input-group-text">sq ft</span>
                                                        </div>
                                                    </div>
                                                    <div>
                                        ...
                                        <div class="tab-pane" id="settings2">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4 fm">
                                                    ...
                                                    <input type="text" id="quantity" name="quantity" minlength="1" maxlength="3" oninput="number_only(this)" class="form-control">
                                                </div>
                                                <div class="col-md-4 fm">
                                                    <label class="form-label">Description</label>
                                                    <textarea class="form-control" id="description" name="description" oninput="description_val(this)" style="height: 60px"></textarea>
                                                </div>
                                            </div>
                                            <div>
