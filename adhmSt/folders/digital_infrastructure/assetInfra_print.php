        ...
        foreach ($file_names as $file_key => $doc_file_name) {
            ...
            if ($doc_file_name) {
                ...
                if (($cfile_name[1] == 'jpg') || ($cfile_name[1] == 'png') || ($cfile_name[1] == 'jpeg')) {
                    // $image_view .= '<a href="javascript:print_view(\'/' . $doc_file_name . '\')"><img src="../../uploads/' . $folder_name . '/' . $doc_file_name . '"  height="30px" width="30px" ></a>';
                   
                    $image_view .= '<a href="javascript:print_view(\'/' .  $doc_file_name . '\')"><img src="../../assets/images/images.png"  height="30px" width="30px" ></a>';
