...
$from_year = "2020";
$to_year = "2021";
$user_type_unique_id = "65d5c08ca6ad312866";
        ...
        if ($extracted_token == $token) {
            ...
            if ($captcha == $_SESSION['captcha_text'] && $captcha != "") {
                ...
                $columns = [
                    ...
                    // '(select std_name from st_app_p1 join staff_registration on st_app_p1.hostel_taluk = staff_registraton.taluk_office)as student_name'
                ...
                if ($action_obj->status) {
                    ...
                    if ($count_data == 1) {
                        ...
                        $hostel_values = $user['hostel_id'];


                        // <label for="site" class="col-12 col-xl-12 col-form-label">Site Name </label>
                        //             <div class="col-12 col-xl-12 mrg-btm">
                        //                 <select name="site_name" id="site_name" onChange="get_plant_name(this.value)" class="select2 form-control" required>
                        //                     <!--<option value=''>Select</option>-->

                        // <?php 


                        // sp_tahsildar_hostel_list($hostel_values);
