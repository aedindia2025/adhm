...
function statusFilter(filter_action = 0) {
...
function leave_print(unique_id="") {
	...
	var external_window = window.open('folders/leave_approval/print.php?unique_id='+unique_id, 'onmouseover', 'height=600,width=900,scrollbars=yes,resizable=no,left=200,top=150,toolbar=no,location=no,directories=no,status=no,menubar=no');
...
function leave_approval_cu(unique_id = "") {
	var internet_status = is_online();
