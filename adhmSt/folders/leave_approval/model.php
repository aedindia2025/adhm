                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-md-3 fm" id="reject_reason_div" style="display:none;">
                                            ...
                                            <textarea id="reject_reason" name="reject_reason" class="form-control" required><?= $reject_reason; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <input type="hidden" id="warden_name" name="warden_name" class="form-control" value="<?= $userid; ?>"></input>
                            <div class="btns">
