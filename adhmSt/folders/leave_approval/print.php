...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        $columns = [
            ...
            // "(select staff_name from staff_registration where staff_registration.hostel_name = $table.hostel_name and staff_registration.user_type ='65cb092facaf836335') as warden_names",
            "(select staff_name from staff_registration where staff_registration.unique_id = $table.warden_name) as warden_names",
            "approval_status",
            "reject_reason"
        ];
        ...
        if ($result_values->status) {
            ...
            $warden_names        = $result_values[0]["warden_names"];
        ...
        <div class="col-sm-12 ">
            <div class="mt-0 float-sm-left">
                <div class="row">
                    ...
                    <!-- <div class="col-sm-6">
                        <p class="font-12">Warden Name: <strong><?= $warden_names; ?></strong></p>
                    </div> -->
                    <div class="col-sm-6">
