...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $accept_reason      = $result_values[0]["accept_reason"];
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Renewal Accept Reason</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    <form class="was-validated" autocomplete="off">
                                        <div class="row mb-3">
                                            <div class="col-md-3 fm">
                                                ...
                                                <input type="text" class="form-control" id="accept_reason"
                                                    oninput="validateCharInput(this)" name="accept_reason" value="<?php echo $accept_reason; ?>" required>
                                            </div>
