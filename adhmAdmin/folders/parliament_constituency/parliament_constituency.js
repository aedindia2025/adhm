...
var form_name 	= 'Parliament Constituency';
var form_header = '';
var form_footer = '';
var table_name 	= '';
var table_id 	= 'parliament_constituency_datatable';
...
function init_datatable(table_id = '', form_name = '', action = '') {
	...
	var datatable = table.DataTable({
		...
		},
		{
			...
			title: 'Parliament Constituency',
			filename: 'parliament_constituency'
		},
		{
			extend: 'excelHtml5',
			exportOptions: {
...
function parliament_constituency_cu(unique_id = "") {
	...
	if (is_form) {
        ...
        var media_url = "https://nallosaims.tn.gov.in/adw_biometric/folders/parliament_constituency/crud.php";
...
function parliament_constituency_delete(unique_id = "") {
