...
switch ($action) {
    ...
    case 'createupdate':
        ...
        $taluk = sanitizeInput($_POST["taluk_name"]);
        $district = sanitizeInput($_POST["district"]);
        $land_type = sanitizeInput($_POST["land_type"]);
        $owner_of_land = sanitizeInput($_POST["owner_of_land"]);
        ...
        $existing_demolished = sanitizeInput($_POST["existing_demolished"]);
        $no_floors = sanitizeInput($_POST["no_floors"]);
        $toilet_each_floor = sanitizeInput($_POST["toilet_each_floor"]);
        $compound_wall = sanitizeInput($_POST["compound_wall"]);
        ...
        $demolished = sanitizeInput($_POST["demolished"]);
