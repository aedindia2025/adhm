...
if (isset($_GET['unique_id'])) {
    if (!empty($_GET['unique_id'])) {
        ...
        if ($result_values->status) {
            ...
            $expenses_type = $result_values[0]['expenses_type'];
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Expenses Type</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
...
<input type="hidden"  id="csrf_token" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md-3 fm">
                                            <label for="simpleinput" class="form-label">Expenses Type</label>
                                            <input type="text" class="form-control" id="expenses_type" name="expenses_type" oninput="validateCharInput(this)"  value="<?php echo $expenses_type; ?>" required>
                                        </div>
