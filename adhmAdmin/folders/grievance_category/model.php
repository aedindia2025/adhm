                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <input name="unique_id" id="unique_id" type="hidden" value="<?php echo $unique_id; ?>"> 
                                    <div class="col-4">
                                        <label for="example-select" class="form-label">Grievance Details</label>
                                        <textarea name="description" id="description" class="form-control" rows="2" col="20" required><?php echo $description; ?></textarea>
                                    </div>

                                    <div class="col-md-4 fm">
                                        <label for="product_category" class="form-label">File Upload</label>
                                        <input type="file" id="test_file" name="test_file" class="form-control" accept=".doc, .docx, .pdf, .txt, image/*" required>
                                        <input type="hidden" id="file_name" name="file_name" value="<?php echo $file_names; ?>">
                                    </div>
