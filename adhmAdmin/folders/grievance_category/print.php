    ...
    //         }
            ...
            if ($doc_file_name) {
                ...
                if (($cfile_name[1] == 'jpg') || ($cfile_name[1] == 'png') || ($cfile_name[1] == 'jpeg')) {
                    // echo "dd";
                    $image_view .= '<a href="javascript:print_view(\'/' . $doc_file_name . '\')"><img src="../../../adhmStudent/uploads/grievance_category/' . $doc_file_name . '"  width="20%" ></a>';
...
<script>
	...
	// 	 onmouseover=window.open('../../../adhmStudent/uploads/grievance_category/' + file_name, '_blank','height=600,width=900,scrollbars=yes,resizable=no,left=200,top=150,toolbar=no,location=no,directories=no,status=no,menubar=no');
	// }
    ...
    function print_pdf(file_name) {
	var pdfUrl = "../../../adhmStudent/uploads/grievance_category/" + file_name;
...
function print(file_name) {
	...
	var excelUrl = "../../../adhmStudent/uploads/grievance_category/" + file_name;
	var link = document.createElement("a");
	link.href = excelUrl;
	link.download = file_name;
	document.body.appendChild(link);
...
function print_view(file_name) {
	var iframeContent = '<html><head><style>body, html {width: 100%; height: 100%; margin: 0; padding: 0;}</style></head><body>' +
		'<iframe id="myIframe" src="../../../adhmStudent/uploads/grievance_category/' + file_name + '"' + ' style="height:100%; width:100%; border:none;"></iframe>' +
		'</body></html>';
