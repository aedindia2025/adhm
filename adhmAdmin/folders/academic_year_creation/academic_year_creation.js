...
var form_name 		= 'Academi Year';
var form_header		= '';
var form_footer 	= '';
var table_name 		= '';
var table_id 		= 'academic_year_datatable';
...
function academic_year_creation_cu(unique_id = "") {
    ...
    if (is_form) {
        ...
        var ajax_url = sessionStorage.getItem("folder_crud_link");
		var media_url = "https://nallosaims.tn.gov.in/adw_biometric/folders/academic_year_creation/crud.php";
...
function academic_year_creation_delete(unique_id = "") {
