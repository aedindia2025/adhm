...
var form_footer = '';
var table_name = '';
var table_id = 'std_registration_report_datatable';
...
function init_datatable(table_id = '', form_name = '', action = '') {
    ...
    var ajax_url = "https://nallosaims.tn.gov.in/adw_biometric/folders/std_registration_report/crud.php";
    ...
    var datatable = table.DataTable({
        ...
        lengthMenu: [[10, 50, 100, 500, 1350], [10, 50, 100, 500, "Max"]],
        pageLength: 10,
        buttons: [
            {
                extend: 'copyHtml5',
            ...
            },
            {
                ...
                exportOptions: { columns: ':visible' },
                title: 'Student Registration Report',
                filename: 'student_registration_report'
            },
            {
                extend: 'excelHtml5',
                exportOptions: { columns: ':visible' },
...
$("#export").click(function () {
    ...
    $.ajax({
        url: "https://nallosaims.tn.gov.in/adw_biometric/folders/std_registration_report/excel.php",
        type: "GET",
        xhrFields: {
