...
var form_footer = '';
var table_name = '';
var table_id = 'dadwo_level_pending_datatable';
...
function init_datatable(table_id = '', form_name = '', action = '') {
	...
	var ajax_url = "folders/dadwo_level_pending/crud.php";
...
$("#export").click(function () {
	...
	$.ajax({
		url: "folders/dadwo_level_pending/excel.php",
		type: "GET",
		data: filterdata,
		xhrFields: {
		...
		success: function (data) {
			...
			link.href = url;
			link.download = 'Dadwo_level_pending_list.xls'; // Set the filename
