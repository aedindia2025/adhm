...
var form_footer 		= '';
var table_name 			= '';
var table_id 			= 'leave_approvel_datatable';
var action 				= "datatable";

function staffStatusFilter(filter_action = 0) {
...
function init_datatable(table_id = '', form_name = '', action = '', filter_data = '') {
	...
	buttons: [{
		...
		},
		{
			...
			title: 'Student Leave Approval',
			filename: 'student_leave_approval'
		},
		{
			extend: 'excelHtml5',
			exportOptions: {
...
function leave_print(unique_id="") {
	...
	var external_window = window.open('folders/student_leave_approval/print.php?unique_id='+unique_id, 'onmouseover', 'height=600,width=900,scrollbars=yes,resizable=no,left=200,top=150,toolbar=no,location=no,directories=no,status=no,menubar=no');
// external_window.print();
// external_window.print();
}

function student_leave_approval_cu(unique_id = "") {
	var internet_status = is_online();
