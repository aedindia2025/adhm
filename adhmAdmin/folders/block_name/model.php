                                ...
                                <div class="card-body">
                                    <form class="was-validated" autocomplete="off">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3 fm">
                                                <label for="assembly_const_name" class="form-label">Block Name</label>
                                                <input type="text" class="form-control" id="block_name" name="block_name" oninput="validateCharInput(this)"  value="<?php echo $block_name; ?>" required>
                                            </div>
                                            <div class="col-md-3">
