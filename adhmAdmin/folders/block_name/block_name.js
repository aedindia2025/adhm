...
function block_name_cu(unique_id = "") {
	...
	if (is_form) {
		...
		var ajax_url = sessionStorage.getItem("folder_crud_link");
		var media_url = "https://nallosaims.tn.gov.in/adw_biometric/folders/block_name/crud.php";
...
function block_name_delete(unique_id = "") {
