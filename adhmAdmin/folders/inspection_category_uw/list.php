...
<div class="container-fluid">
        ...
        <div class="row">
            ...
            <h4 class="page-title">Inspection Category</h4>
            </div>
            </div>
            <div class="col-md-2 align-self-center">
            <div class="page-title-right">
             <a href="index.php?file=inspection_category/model">  <button  class="btn btn-primary" style="float: right;">Add New</button></a>
            </div>
            </div>
        </div>
