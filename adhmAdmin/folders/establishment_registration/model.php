...
$district_name_lists = select_option($district_name_list, "Select District", $district_name);
                                                ...
                                                <form class="was-validated" autocomplete="off">
                                                    <div class="row mb-3">
                                                        <div class="col-md-6 fm">
                                                            ...
                                                            <input type="text" id="staff_name" oninput="valid_user_name(this)" name="staff_name" required class="form-control" value="<?php echo $staff_name; ?>">
                                                        </div>

                                                        <div class="col-md-6 fm">
                                                            <label for="simpleinput" class="form-label">Father's
                                                                Name</label>
                                                            <input type="text" id="father_name" name="father_name" oninput="valid_user_name(this)" class="form-control" required value="<?php echo $father_name; ?>">
                                                        </div>
                                                        <div class="col-md-6 fm">
                                                        ...
                                                        <div class="col-md-6 fm">
                                                            ...
                                                            <input type="date" id="dateofbirth"  name="dateofbirth" class="form-control" onchange="calculateAge()" value="<?php echo $dob; ?>" required>
                                                        </div>
                                                        <div class="col-md-6 fm">
                                                        ...
                                                        <!-- <div class="col-md-6 fm ">
                                                            ...
                                                            <input type="number" id="mobile_num"  oninput="valid_mobile_number(this)" maxlength="10" minlength="10" name="mobile_num" required class="form-control" value="<?php echo $mobile_num; ?>">
                                                        </div> -->
                                                        <div class="col-md-6 fm ">
                                                            <label for="simpleinput" class="form-label">Mobile No</label>
                                                            <input type="text" id="mobile_num" name="mobile_num" required class="form-control" maxlength="10" minlength="10" oninput="valid_mobile_number(this)" value="<?php echo $mobile_num; ?>">
                                                        </div>
                                                        <div class="col-md-6 fm ">
                                                            <label for="example-select" class="form-label">District Name</label>
                                                            <select class="select2 form-control" id="district_name" name="district_name" required onchange="taluk()">
                                                                <?php echo $district_name_lists; ?>
                                                            </select>
                                                        </div>
                                                        <div class="col-md-6 fm ">
                                                            <label for="example-select" class="form-label">Taulk Name</label>
                                                        ...
                                                        <div class="col-md-6 fm ">
                                                            ...
                                                            <textarea type="text" id="address" oninput="validateCharInput(this)" name="address" required class="form-control"> <?php echo $address; ?></textarea>
                                                        </div>
                                                        <!-- <div class="col-md-6 fm ">
                                                            <label for="simpleinput" class="form-label">Aadhar Number</label>
                                                            <input type="text" id="aadhaar_no" oninput="valid_aadhar_number(this)" required name="aadhaar_no" max="12" class="form-control" value="<?php echo $aadhaar_no; ?>" maxlength="12" minlength="12" onkeyup="onAadharKeyPress()">
                                                        </div> -->
                                                        <div class="col-md-6 fm ">
                                                            <div class="">
                                                                <label class="form-label" for="example-select">E-mail Id</label>
                                                                <input type="email" class="form-control" oninput="mail_valid(this)" id="email_id" required name="email_id" value="<?php echo $email_id; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 fm">
                                    ...
                                    <div class="tab-pane" id="arrow-contact" role="tabpanel">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 fm">
                                                ...
                                                <input type="text" id="department" oninput="valid_user_name(this)" name="department" class="form-control" required value="<?php echo $department; ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 fm">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="password" id="password" oninput="valid_password(this)" class="form-control" placeholder="" value="<?php echo $password; ?>">
                                            ...
                                            <div class="col-md-6 fm">
                                                ...
                                                <div class="input-group input-group-merge">
                                                    <input type="password" id="confirm_password" oninput="valid_password(this)"  class="form-control" placeholder="" value="<?php echo $confirm_password; ?>">
                                                    <div class="input-group-text" data-password="false">
                                                        <span class="password-eye"></span>
                                                    </div>
                                                </div>
