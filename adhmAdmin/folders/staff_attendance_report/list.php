...
$establishment_type_list = establishment_type();
$establishment_type_list = select_option($establishment_type_list, "Select Designation", $establishment_type);
...
<div class="content-page">
    <div class="content">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-10">
                    <div class="page-title-box">
                        <h4 class="page-title">Staff Attendance Report</h4>
                    </div>
                </div>
            </div>
            <div class="row">
                            ...
                            <div class="row">
                                ...
                                <div class="col-3 mt-2">
                                    ...
                                    <select name="establishment_type" id="establishment_type"
                                        ...
                                        <?php echo $establishment_type_list ?>
                                    </select>
                                </div>
            ...
            <button type="button" id="export" name="export" class="btn   waves-effect waves-light wavw  mb-1"
            ...
            <button type="button" id="consolidated_export" name="consolidated_export"
                class="btn   waves-effect waves-light wavw  mb-1"
                style="background:rgb(13, 13, 13);color: #fff;font-size:16px;">
                <i class="ri-file-excel-2-fill"
                    style="font-size: 22px; padding-right: 10px;line-height: 0px;vertical-align: middle;"></i>Consolidated
                Export
            </button>
            <div class="row">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="staff_attendance_datatable" class="table dt-responsive w-100">
                                <thead>
                                    <tr>
                                        <th>S.no</th>
                                        <th>Hostel ID</th>
