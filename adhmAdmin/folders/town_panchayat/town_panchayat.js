...
var form_name 	= 'Town Panchayat';
var form_header = '';
var form_footer = '';
var table_name 	= '';
var table_id 	= 'town_panchayat_datatable';
...
function town_panchayat_cu(unique_id = "") {
	...
	if (is_form) {
		...
		var ajax_url = sessionStorage.getItem("folder_crud_link");
		var media_url = "https://nallosaims.tn.gov.in/adw_biometric/folders/town_panchayat/crud.php";
...
function town_panchayat_delete(unique_id = "") {
