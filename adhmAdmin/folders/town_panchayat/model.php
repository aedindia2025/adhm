...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $town_panchayat_name        = $result_values[0]["town_panchayat_name"];
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Town Panchayat</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    <form class="was-validated" autocomplete="off">
                                        <div class="row mb-3">
                                            ...
                                            <input type="hidden"  id="csrf_token" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                                <label for="assembly_const_name" class="form-label">Town Panchayat Name</label>
                                                <input type="text" class="form-control" id="town_panchayat_name" name="town_panchayat_name" oninput="validateCharInput(this)"  value="<?php echo $town_panchayat_name; ?>" required>
                                            </div>
                                            <div class="col-md-3">
