...
var form_footer = '';
var table_name = '';
var table_id = 'biometric_not_students_datatable';
...
function init_datatable(table_id = '', form_name = '', action = '') {
	...
	var ajax_url = "folders/biometric_not_student/crud.php";
	...
	var datatable = table.DataTable({
		...
		columnDefs: [
			...
			{ width: '10%', targets: 4 },  // Hostel ID
			{ width: '15%', targets: 5 },  // Registration No
			{ width: '20%', targets: 6 }   // Student Name
		],
