            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Special Tahsildar</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                ...
                                <div class="card-body">
                                    <form class="was-validated" autocomplete="off">
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3 fm">
                                                <label for="simpleinput" class="form-label">Special Tahsildar</label>
                                                <input type="text" class="form-control"   oninput="validateCharInput(this)" id="special_tahsildar" name="special_tahsildar"
                                                    value="<?=$special_tahsildar;?>" required>
