            ...
            if (count($result->data) == '0') {
                ...
                foreach ($res_array as $key => $value) {
                    ...
                    if ($value['cam_link2'] == '') {
                        ...
                        $card_content = '<iframe width="100" height="300" src="https://nallosaims.tn.gov.in:5443/Chennai/play.html?id=' . $value['cam_link1'] . '" frameborder="0" allowfullscreen></iframe>';
                    } else {
                        $card_content = '<div style="display: flex;">'
                            . '<iframe width="50%" height="300" src="https://nallosaims.tn.gov.in:5443/Chennai/play.html?id=' . $value['cam_link1'] . '" frameborder="0" allowfullscreen style="margin-right: 10px;"></iframe>'
                            . '<iframe width="50%" height="300" src="https://nallosaims.tn.gov.in:5443/Chennai/play.html?id=' . $value['cam_link2'] . '" frameborder="0" allowfullscreen></iframe>'
                            . '</div>';
                    }
