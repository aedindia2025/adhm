                                ...
                                <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                        <li class="nav-item">
                                            <a href="#basictab1" data-bs-toggle="tab" data-toggle="tab"
                                                ...
                                                <span class=" d-sm-inline">Hostel Wise</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#basictab2" data-bs-toggle="tab" data-toggle="tab"
                                                ...
                                                <span class=" d-sm-inline">Asset Wise</span>
                                            </a>
                                        </li>
...
<div>
                            ...
                            <button type="button" id="export_asset" name="export_asset"
                                class="btn   waves-effect waves-light wavw  mb-1"
                                style="background: #337734;color: #fff;font-size:16px;">
                                <i class="ri-file-excel-2-fill"
                                    style="font-size: 22px; padding-right: 10px;line-height: 0px;vertical-align: middle;"></i>Export
                            ...
                            <table id="asset_wise_datatable" class="table  w-100">
                                <thead>
                                    <tr>
                                        <th>S.no</th>
                                        <th>Category</th>
