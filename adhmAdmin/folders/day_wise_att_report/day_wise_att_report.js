...
var form_name = 'Day Wise Attendance Report';
var form_header = '';
var form_footer = '';
var table_name = '';
var table_id = 'day_wise_att_report_datatable';
    ...
    var datatable = table.DataTable({
        ...
        buttons: [
            ...
            },
            {
                extend: 'csvHtml5',
                title: 'Biometric Attendance Report',
                filename: 'biometric_attendance_report'
            },
            {
                extend: 'excelHtml5',
                title: 'Biometric Attendance Report',
...
$("#export").click(function () {
    ...
    $.ajax({
        url: "folders/biometric_attendance_report/excel.php",
        type: "GET",
        data: {
            from_date: from_date,
            to_date: to_date,
        ...
        success: function (data) {
            ...
            link.href = url;
            link.download = 'Biometric_Attendance_Report.xls'; // Set the filename
