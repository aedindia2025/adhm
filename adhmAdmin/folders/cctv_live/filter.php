...
$district_name_list = select_option($district_name_list, 'Select District', $_GET['district_name']);     
$taluk_name_list = taluk_name();
$taluk_name_list = select_option($taluk_name_list, 'Select Taluk', $_GET['taluk_name']);
$hostel_name_list = hostel_name();
$hostel_name_list = select_option_host($hostel_name_list, 'Select Hostel', $_GET['hostel_name']);
        ...
        <div class="row mb-3">
          ...
          <div class="col-md-3 mt-2">
            <div class="page-title-right">
                  ...
                  <button class="btn btn-primary"  onclick="get_list()">Go</button>
