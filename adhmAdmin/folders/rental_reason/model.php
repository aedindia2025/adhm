            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Rental Reason</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    <form class="was-validated" autocomplete="off">
                                        <div class="row mb-3">
                                            <div class="col-md-3 fm">
                                                ...
                                                <input type="text" class="form-control" id="rental_reason"
                                                oninput="validateCharInput(this)"     name="rental_reason" value="<?php echo $rental_reason;?>" required>
                                            </div>
