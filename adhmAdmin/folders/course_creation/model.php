...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $college_name               = $result_values[0]["college_unique_id"];
...
$college_name_options = select_option($college_name_options, "Select College", $college_name);
                                    ...
                                    <form class="was-validated" autocomplete="off"> 
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3 fm">
                                                ...
                                                <input type="text" class="form-control" id="course_name" name="course_name" oninput="validateCharInput(this)"  value="<?php echo $course_name; ?>" required>
                                            </div>
                                            <div class="col-md-3">
