    ...
    if (isset($_GET["unique_id"])) {
        if (!empty($_GET["unique_id"])) {
            ...
            $columns = [
				...
				"(select district_name from district_name where district_name.unique_id = stock_entry.district) as district_name",
				"(select taluk_name from taluk_creation where taluk_creation.unique_id = stock_entry.taluk) as taluk_name",
    							...
    							<table cellspacing="0" cellpadding="0" class="" width="100%" style="font-family: monospace;">
    								<thead class="colspanHead">
    									<tr>
    										...
    										<th width="10%" colspan="1" class="blankCell">Product Category</th>
    										<th width="10%" colspan="1" class="blankCell">Item Name</th>
    										<th width="10%" colspan="1" class="blankCell">Quantity</th>
...
$where_list = "screen_unique_id = '".$screen_unique_id."' and is_delete = 0";
...
// echo "d";
												...
												$table_data .= "<td style = 'text-align : left'>" . disname($value['category_name']) . "</td>";
												$table_data .= "<td style = 'text-align : left'>" . disname(product_type_name($value['item_name'])[0]['product_type']) . "</td>";
												$table_data .= "<td style = 'text-align : right'>" . $value['qty'] . "</td>";
