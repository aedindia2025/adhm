...
$block_name_options = "<option value=''>Select Block</option>";
...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $block_options = block("", $district_name);
    
            $block_options = select_option($block_options, "Select Block Name",$block_name);
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        <h4 class="page-title">Village</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    <form class="was-validated" autocomplete="off">
                                        <div class="row mb-3">
                                            <div class="col-md-3 fm">
                                                ...
                                                <select class="form-select" id="district_name" name="district_name" onchange="get_block_name()" required>
                                                    <?php echo  $district_name_options; ?>
                                                </select>
                                            </div>
                                            <div class="col-md-3 fm">
                                                <label for="block_name" class="form-label">Block Name</label>
                                                <select class="form-select" id="block_name" name="block_name" required value="">
                                                    <?php echo $block_options; ?>
                                                </select>
                                            </div>
                                            <div class="col-md-3 fm">
                                                <label for="assembly_const_name" class="form-label">Village Name</label>
                                                <input type="text" class="form-control" id="village_name" name="village_name" oninput="validateCharInput(this)"  value="<?php echo $village_name; ?>" required>
