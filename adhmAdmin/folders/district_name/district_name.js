...
function district_name_cu(unique_id = "") {
	...
	if (is_form) {
		...
		var media_url = "https://nallosaims.tn.gov.in/adw_biometric/folders/district_name/crud.php";
		var ajax_url = sessionStorage.getItem("folder_crud_link");
...
function district_name_delete(unique_id = "") {
