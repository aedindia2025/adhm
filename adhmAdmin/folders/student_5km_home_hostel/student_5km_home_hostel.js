...
var form_footer = '';
var table_name = '';
var table_id = 'students_bellow_5km_datatable';
...
function init_datatable(table_id = '', form_name = '', action = '') {
	...
	var ajax_url = "folders/student_5km_home_hostel/crud.php";
...
$("#export").click(function () {
	...
	$.ajax({
		...
		url: "folders/student_5km_home_hostel/excel.php",
		type: "GET",
		data: filterdata,
		xhrFields: {
		...
		success: function (data) {
			...
			link.href = url;
			link.download = 'Student_5KM_away_from_hostel_list.xls'; // Set the filename
