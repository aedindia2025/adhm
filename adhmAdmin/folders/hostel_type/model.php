            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Hostel Type Form</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    <form class="was-validated" autocomplete="off">
                                        <div class="row mb-3">
                                            <div class="col-md-3 fm">
                                                ...
                                                <input type="text" oninput="validateCharInput(this)"  class="form-control" id="hostel_type" name="hostel_type" value="<?php echo $hostel_type; ?>" required>
                                            </div>
                                            <div class="col-md-3">
