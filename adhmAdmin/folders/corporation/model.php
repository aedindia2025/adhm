...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $corporation_name           = $result_values[0]["corporation_name"];
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Corporation</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    <form class="was-validated" autocomplete="off">
                                        <div class="row mb-3">
                                            ...
                                            <input type="hidden"  id="csrf_token" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                                <label for="assembly_const_name" class="form-label">Corporation</label>
                                                <input type="text"  oninput="validateCharInput(this)"  class="form-control" id="corporation_name" name="corporation_name" value="<?php echo $corporation_name; ?>" required>
                                            </div>
                                            <div class="col-md-3">
