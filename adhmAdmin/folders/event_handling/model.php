                                    ...
                                    <form class='was-validated' autocomplete='off'>
                                        ...
                                        <div class='row'>
                                            <div class='col-md-4 fm'>
                                                ...
                                                <input type='text'readonly id='cur_date' name='cur_date' class='form-control'
                                                    value="<?php echo $cur_date; ?>" required>
                                            </div>
                                            <div class='col-md-4 fm'>
                                                <label class='form-label'>Event Name</label>
                                                <input type='text' id='event_name' oninput="valid_user_name(this)" name='event_handling'
                                        ...
                                        <div class="row">
                                            <div class='col-md-6 fm'>
                                                ...
                                                <textarea id='remarks' oninput="valid_user_name(this)" name='remarks' class='form-control'
...
">
                <div class="row mt-2">
                    <video id="video-help" width="530" controls>
                        <source id="videoPath" src="../adhmHostel/uploads/event_handling/videos/<?php echo $video_file_name;?>"
                            type="video/mp4">
                    </video>
    ...
    if($image_file_name){
            foreach ($file_names as $file_key => $image_file_name){ 
                ...
                if($image_file_name){  
                    ...
                    $image_view .= '<a href="javascript:print(\'../adhmHostel/uploads/event_handling/images/'.$image_file_name.'\')"><img src="../adhmHostel/uploads/event_handling/images/'.$image_file_name.'"  height="80px" width="77px" ></a>';
   ...
   var data = new FormData();
    ...
    data.append("action", actions);
        ...
        function print_pdf(file_name) {
            onmouseover = window.open('../adhmHostel/uploads/event_handling/documents/' + file_name, 'onmouseover',
