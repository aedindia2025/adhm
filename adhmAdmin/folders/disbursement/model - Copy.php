...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        $columns    = [
            ...
            "dadwo_letter_date",
            "dadwo_attach_file",
            '(SELECT staff_name FROM user WHERE user.unique_id = ' . $table . '.dadwo_off_name ) AS dadwo_off_name',
            "unique_id"
        ];
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">  
                                        ...
                                        <div class="col-md-4 fm">
                                            <label for="simpleinput" class="form-label">Hostel Name</label><br>
                                            <label for="simpleinput" class="form-label"><h4><?= $hostel_name ?></h4></label>
                                    ...
                                    <div class="head">
                                        ...
                                        <!-- <div class="col-md-6">
                                            ...
                                            <label for="main_screen" class="form-label">SP. Tahsildar Attached Document</label>
                                    ...
                                    <div class="head">
                                        ...
                                        <div class="row">
                                        <div class="col-md-4 fm">
                                            <label for="simpleinput" class="form-label">DADWO Officer Letter No.</label><br>
                                            <label for="simpleinput" class="form-label"><h4><?=$tah_letter_no?></h4></label>
                                        
                                        </div>

                                        <div class="col-md-4 fm">
                                            <label for="simpleinput" class="form-label">DADWO Officer Letter Date</label><br>
                                            <label for="simpleinput" class="form-label"><h4><?=$tah_letter_date?></h4></label>
                                        
                                        </div>
                                        <div class="col-md-4 fm">
                                            <label for="simpleinput" class="form-label">DADWO Officer Name</label><br>
                                            <label for="simpleinput" class="form-label"><h4><?=$tahsildar_name;?></h4></label>
