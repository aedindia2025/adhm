...
// print_r($result_values);
        if ($result_values->status) {
            ...
            $institution_name        = $result_values[0]["institution_name"];
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Institution Master</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                ...
                                <div class="card-body">
                                    <form class="was-validated" autocomplete="off">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3 fm">
                                                <label for="simpleinput" class="form-label">Institution Name</label>
                                                <input type="text" class="form-control"   oninput="validateCharInput(this)" id="institution_name" name="institution_name"
                                                    value="<?=$institution_name;?>" required>
