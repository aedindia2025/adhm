...
var form_name 		= 'Zone Name';
var form_header		= '';
var form_footer 	= '';
var table_name 		= '';
var table_id 		= 'institution_master_datatable';
...
function institution_master_cu(unique_id = "") { 
    ...
    if (is_form) {
        ...
        var ajax_url = sessionStorage.getItem("folder_crud_link");
		var media_url = "https://nallosaims.tn.gov.in/adw_biometric/folders/institution_master/crud.php";
...
function institution_master_delete(unique_id = "") {
