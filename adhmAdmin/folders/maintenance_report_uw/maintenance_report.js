...
function print_pdf(file_name)
    ...
    function view_app(unique_id="") {
		...
		var external_window = window.open('folders/maintenance_report/view_app.php?unique_id='+unique_id, 'onmouseover', 'height=600,width=900,scrollbars=yes,resizable=no,left=200,top=150,toolbar=no,location=no,directories=no,status=no,menubar=no');
