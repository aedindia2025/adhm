...
function print_pdf(file_name) {
	var pdfUrl = "../adhmHostel/uploads/student_marksheet/" + file_name;
...
function print_view(file_name) {
	var iframeContent = '<html><head><style>body, html {width: 100%; height: 100%; margin: 0; padding: 0;}</style></head><body>' +
		'<iframe id="myIframe" src="../adhmHostel/uploads/student_marksheet/' + file_name + '"' + ' style="height:100%; width:100%; border:none;"></iframe>' +
		'</body></html>';
