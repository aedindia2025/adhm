                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        ...
                                        <select name="reg_no" id="reg_no" class="select2 form-control" required>
                                ...
                                <div class="col-md-3">
                                 ...
                                 <div class="col-md-3">
                                    <div class="mb-3">
                                        <label>Status</label>
                                        <select name="sem_status" id="sem_status" class="select2 form-control" required>
                                ...
                                <div class="col-md-3">
                                    <div class="mb-3">
                                        <label>CGPA</label>
                                        <input type="text" name="cgpa" id="cgpa" class="form-control" value="<?php echo $cgpa;?>" dir="rtl" oninput="dec_number(this)" minlength="1" maxlength="5" required>
