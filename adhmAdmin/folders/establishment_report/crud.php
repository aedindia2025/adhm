...
switch ($action) {
    ...
    case 'datatable':
        ...
        $columns = [
            ...
            "(select count(id) from establishment_registration where is_delete = '0' and designation = '679344dd0298475852' and district_name.unique_id = establishment_registration.district_office) as warden",
            "(select count(id) from establishment_registration where is_delete = '0' and designation = '679344eba32e272880' and district_name.unique_id = establishment_registration.district_office) as warden_incharge",
            "(select count(id) from establishment_registration where is_delete = '0' and designation = '679344f6b8df890572' and district_name.unique_id = establishment_registration.district_office) as cook",
            "(select count(id) from establishment_registration where is_delete = '0' and designation = '6793454ad335487663' and district_name.unique_id = establishment_registration.district_office) as deputation_cook",
            "(select count(id) from establishment_registration where is_delete = '0' and designation = '67934553276a759813' and district_name.unique_id = establishment_registration.district_office) as watchman",
            "(select count(id) from establishment_registration where is_delete = '0' and designation = '6795b2be36a0239724' and district_name.unique_id = establishment_registration.district_office) as sweeper",
            "unique_id"
        ];
        $table = "district_name"; // Adjust your table name here
        $table_details = $table . " , (SELECT @a:= ?) AS a ";
        $where = "is_delete = ?";
        $bind_params = "ii"; // Types of parameters (s for string)
        $bind_values = [$start, '0'];
