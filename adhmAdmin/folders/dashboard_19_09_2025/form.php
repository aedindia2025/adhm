    ...
    <!-- <script src="https://cdn.jsdelivr.net/npm/chart.js"></script> -->
			...
			<div class="row mb-3">
                            ...
                            <div class="col-md-3 fm mt-3">
                                <div class="page-title-right">
                                    <form class="d-flex">
                                        <button type="button" class="btn btn-primary" onclick="get_application_count()">Filter</button>
                                    </form>
                                </div>
                            </div>
                        </div>
						...
						<div class="card-body">
							<div class="d-flex align-items-center">
								...
								<div class="flex-grow-1 c-v">
									...
									<p class="mb-0" id="appl_cnt" onclick="new_external_window_print(event,'folders/dashboard/print.php','applied');"></p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body">
							<div class="d-flex align-items-center">
								...
								<div class="flex-grow-1 c-v">
									...
									<p class="mb-0" id="accp_cnt" onclick="new_external_window_print(event,'folders/dashboard/print.php','acceptance');"></p>
								</div>
							</div>
						</div>
					</div>
						...
						<div class="card-body">
							<div class="d-flex align-items-center">
								...
								<div class="flex-grow-1 c-v">
									...
									<p class="mb-0" id="appr_cnt" onclick="new_external_window_print(event,'folders/dashboard/print.php','approved');"></p>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="card mb-0"> 
						<div class="card-body">
							<div class="d-flex align-items-center">
								...
								<div class="flex-grow-1 c-v">
									...
									<p class="mb-0" id="rej_cnt" onclick="new_external_window_print(event,'folders/dashboard/print.php','rejected');"></p>
								</div>
							</div>
						</div>
					</div>
                        ...
                        <div class="row">
                            ...
                            <h3 class="mt-3 mb-3 text-reset" id="total_students"   >
                                    ...
                                    <a href="javascript:void(0)" class="view"  onclick="new_external_window_print_new(event,'folders/dashboard/total_students.php');">Read More</a>
                                </div>
                                    </div> <!-- end col-->
                                    ...
                                    <div class="card-body">
                                     ...
                                     <!-- end card-body-->
              <a href="javascript:void(0)"  onclick="new_external_window_print_new(event,'folders/dashboard/total_hostel.php');"class="view">Read More</a>
                                </div>
                                    </div> <!-- end col-->
                                    ...
                                    <a href="javascript:void(0)" onclick="new_external_window_print_new(event,'folders/dashboard/total_staffs.php');" class="view">Read More</a>
                                </div>
                                    </div> <!-- end col-->
                                    ...
                                    <a href="javascript:void(0)" onclick="new_external_window_print_new(event,'folders/dashboard/hostel_vaccancy.php');" class="view">Read More</a>
                                </div>
                                    </div> <!-- end col-->
                                    ...
                                    <div class="card-body">
                                        ...
                                        <h6 class=" mt-0 hh-6">Student Leave Application</h6>
                                        <h2 class="my-2 mt-3 mb-3" id="no_of_student_name"></h2>
                                      
                                    </div> <!-- end card-body-->
                                    <a href="javascript:void(0)" onclick="new_external_window_print_new(event,'folders/dashboard/student_leave.php');" class="view">Read More</a>
                                </div>
                                    </div> <!-- end col-->
                                    ...
                                    <div class="card-body">
                                        <i class=" uil-file-alt float-end"></i>
                                        <h6 class=" mt-0 hh-7">Staff Leave Application</h6>
                                        <h2 class="my-2 mt-3 mb-3" id="staff_name"></h2>
                                        
                                    </div> <!-- end card-body-->
                                    <a href="javascript:void(0)"  onclick="new_external_window_print_new(event,'folders/dashboard/staff_leave.php');" class="view">Read More</a>
                                </div>
                                    </div> <!-- end col-->
                            ...
                            <div class="col-xl-12 col-lg-12">
                                <div class="card card-h-100">
                                    <div class="d-flex card-header justify-content-between align-items-center">
                                        <h4 class="header-title">District wise Register</h4>
                                    </div>
                                    <div class="card-body pt-0">
                                        <div dir="ltr">
                                            <div id="high-performing-product_1" class="apex-charts" data-colors="#727cf5,#91a6bd40"></div>
                                        </div>
               ...
               <footer class="footer">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-md-8">
                                <script>document.write(new Date().getFullYear())</script> © Adi Dravidar Welfare Department - Managed by <a href="https://aedindia.com/">Ascent e Digit Solutions </a>
                            </div>
                            <div class="col-md-4">
