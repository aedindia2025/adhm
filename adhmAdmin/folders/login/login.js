...
function resetSessionCookie() {
  ...
  document.cookie = "PHPSESSID=; expires=Thu, 01 Jan 1970 00:00:00 UTC; path=/; secure; samesite=strict";
...
function log_sweetalert(msg = '', url = '', callback = '') {
  ...
  switch (msg) {
    ...
    case "invalid_captcha":
      ...
      Swal.fire({
        icon: 'error',
        title: 'User Is Already Logged In On Another Device',
        showConfirmButton: true,
        timer: 5000,
        timerProgressBar: true,
        onClose: () => {
...
//     .then(data => {
//         document.getElementById('ip').textContent = 'Your IP Address is: ' + data.query;
//         document.getElementById('country').textContent = 'Your Country is: ' + data.country;
//     })
//     .catch(error => console.error('Error fetching the IP address and country:', error));
