...
var form_footer = '';
var table_name = '';
var table_id = 'warden_level_pending_datatable';
...
function init_datatable(table_id = '', form_name = '', action = '') {
	...
	var ajax_url = "folders/warden_level_pending/crud.php";
	...
	var datatable = table.DataTable({
		...
		buttons: [
			...
			},
			{
				...
				title: 'Biometric Not Captured Students',
				filename: 'biometric_not_captured_students'
			},
			{
				extend: 'excelHtml5',
				exportOptions: {
...
$("#export").click(function () {
	...
	$.ajax({
		url: "folders/warden_level_pending/excel.php",
		type: "GET",
		data: filterdata,
		xhrFields: {
		...
		success: function (data) {
			console.log("Blob size:", data.size); // should be > 0
			// Create a link element to trigger the download
			var link = document.createElement('a');
			var url = window.URL.createObjectURL(data);
			link.href = url;
			link.download = 'Wardel_level_pending_list.xls'; // Set the filename
