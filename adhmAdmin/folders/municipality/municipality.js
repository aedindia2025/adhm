...
var form_name 	= 'Municipality';
var form_header = '';
var form_footer = '';
var table_name 	= '';
var table_id 	= 'municipality_datatable';
...
function municipality_cu(unique_id = "") {
	...
	if (is_form) {
		...
		var ajax_url = sessionStorage.getItem("folder_crud_link");
		var media_url = "https://nallosaims.tn.gov.in/adw_biometric/folders/municipality/crud.php";
...
function municipality_delete(unique_id = "") {
