...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $municipality_name          = $result_values[0]["municipality_name"];
                                    ...
                                    <form class="was-validated" autocomplete="off">
                                        <div class="row mb-3">
                                            ...
                                            <input type="hidden"  id="csrf_token" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                                <label for="assembly_const_name" class="form-label">Municipality</label>
                                                <input type="text" class="form-control" id="municipality_name" oninput="validateCharInput(this)"  name="municipality_name" value="<?php echo $municipality_name; ?>" required>
                                            </div>
                                            <div class="col-md-3">
