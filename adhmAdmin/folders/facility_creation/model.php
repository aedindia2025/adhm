...
$facility_types      = select_option($facility_types,"Select facility type",$facility_type); 
                                    ...
                                    <input type="hidden"  id="csrf_token" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3 fm">
                                                ...
                                                <input type="text" class="form-control" oninput="validateCharInput(this)"   id="facility_name" name="facility_name" value="<?php echo $facility_name; ?>" required>
                                            </div>
                                            <div class="col-md-3">
