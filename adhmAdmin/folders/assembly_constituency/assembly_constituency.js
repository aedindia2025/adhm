...
var form_name = 'Assembly Constituency';
var form_header = '';
var form_footer = '';
var table_name = '';
var table_id = 'assembly_constituency_datatable';
...
"searching" : false,
		...
		},
		{
			...
			title: 'Assembly Constituency',
			filename: 'assembly_constituency'
		},
		{
			extend: 'excelHtml5',
			exportOptions: {
...
function assembly_constituency_cu(unique_id = "") {
	...
	if (is_form) {
		...
		var ajax_url = sessionStorage.getItem("folder_crud_link");
        var media_url = "https://nallosaims.tn.gov.in/adw_biometric/folders/assembly_constituency/crud.php";
...
function assembly_constituency_delete(unique_id = "") {
