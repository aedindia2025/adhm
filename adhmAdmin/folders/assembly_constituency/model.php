...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $assembly_const_name        = $result_values[0]["assembly_const_name"];
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Assembly Constituency Form</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    <form class="was-validated" autocomplete="off">
                                        <div class="row mb-3">
                                            ...
                                            <!-- <div class="col-md-3 fm">
                                                ...
                                                <select class="form-select" id="taluk_name" name="taluk_name" required value="">
                                                    <?php echo $hostel_taluk_options; ?>
                                                </select>
                                            </div> -->
                                            <div class="col-md-3 fm">
                                                <label for="assembly_const_name" class="form-label">Assembly Constituency</label>
                                                <input type="text" class="form-control" id="assembly_const_name" oninput="validateCharInput(this)"  name="assembly_const_name" value="<?php echo $assembly_const_name; ?>" required>
                                            </div>
                                            <div class="col-md-3">
