...
class UploadManager
{
    ...
    private function saveUpload(Upload $Upload)
    {
        ...
        // echo "Path";print_r($Upload_path_array);

        if ( ! empty($Upload_path_array)) {
            $Upload_path_string = implode(DIRECTORY_SEPARATOR , $Upload_path_array) . DIRECTORY_SEPARATOR;
            // echo "path_str=>".$Upload_path_string;
        } else {
            $Upload_path_string = '';
        }
