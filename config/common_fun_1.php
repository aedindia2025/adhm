...
function application_no($app_number="") {
    global $pdo;
// print_r($app_number);
    ...
    $where = "is_delete = 0 and is_active = 1 and std_app_no = '".$app_number."'";
...
function hostel_type($unique_id = "") {
