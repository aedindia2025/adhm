...
$updateAadhar = $pdo->query("SELECT s1_unique_id FROM aadhar where s1_unique_id = '66a871ff3eef5628'");
...
foreach ($rows as $row) {
    ...
    echo $apiUrl = "https://maps.googleapis.com/maps/api/geocode/json?address=" . urlencode($addressLatLong) . "&key=" . $googleApiKey;
...
if ($apiResponse === false) {
    ...
    echo "No location data found. Full response:\n";
    print_r($apiData);
}
}
