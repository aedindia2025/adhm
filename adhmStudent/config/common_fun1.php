...
// hostel name
function hostel_name($unique_id = '', $zone_name = '')
{
    // echo $zone_name;
...
function feedback_type($unique_id = '')
{
    global $pdo;
    ...
    $feedback_type_list = $pdo->select($table_details, $where);

    if ($feedback_type_list->status) {
        return $feedback_type_list->data;
    } else {
        print_r($feedback_type_list);
