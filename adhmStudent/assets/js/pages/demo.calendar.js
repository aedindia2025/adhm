!function (l) {
    ...
    e.prototype.init = function () {
        var e = new Date(l.now()),
            e = (new FullCalendar.Draggable(document.getElementById("external-events"), { itemSelector: ".external-event", eventData: function (e) { return { title: e.innerText, className: l(e).data("class") } } }), 
            [
                { title: "Practicals - For 12th", start: new Date(l.now() + 158e6), end: new Date(l.now() + 338e6), className: "bg-warning" },
                { title: "Group 4", start: e, end: e, className: "bg-success" },
                { title: "Group 3", start: new Date(l.now() + 168e6), className: "bg-info" },
                { title: "Group 2", start: new Date(l.now() + 338e6), end: new Date(l.now() + 4056e5), className: "bg-primary" }
            ]),
            a = this;
        ...
        a.$btnNewEvent.on("click", function (e) { a.onSelect({ date: new Date, allDay: !0 }) }),
