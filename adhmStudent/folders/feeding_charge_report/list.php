            ...
            <div class="row">
                <div class="col-10">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Feeding Charge</h4>
                    </div>
                </div>
                <div class="row">
                    <div class="col-12">
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 text-end">
                                                            <h4> Total Amount Allocated : 5000</h4>
                                                        </div>
                                                    </div>

                                                    <table id="demo" class="table dt-responsive nowrap w-100">

                                                        <!-- <table id="feedback_type_datatable"  class="table dt-responsive nowrap w-100"  class="table table-bordered nowrap table-striped align-middle"> -->
                                                        <thead>
                                                            <tr>
                                                                <th>S.no</th>
                                                                <th>Date</th>
