...
$feedback_type_list = select_option($feedback_type_list, 'select Feedback Type', $feedback_name);
                    ...
                    <form class="was-validated" autocomplete="off">
                                    ...
                                    <div class="card-body">
                                        <div class="row mb-2">
                                            <div class="col-md-4 fm">
                                                <label for="product_category" class="form-label">STUDENT
                                                    NAME:</label>&nbsp;&nbsp;&nbsp;
                                                <?php echo $_SESSION['std_name']; ?>
                                                <input type="hidden" class="form-control" name="student_name" id="student_name" value="<?php echo $_SESSION['std_name']; ?>">
                                            </div>
                                            <div class="col-md-4 fm">
                                                <label for="product_category" class="form-label">STUDENT
                                                    ID:</label>&nbsp;&nbsp;&nbsp;
                                                <?php echo $_SESSION['std_reg_no']; ?>
                                                <input type="hidden" class="form-control" name="student_id" id="student_id" value="<?php echo $_SESSION['std_reg_no']; ?>">
                                            </div>
                                            <div class="col-md-4 fm">
                                                <label for="product_category" class="form-label">ACADEMIC
                                                    YEAR:</label>&nbsp;&nbsp;&nbsp;
                                                <?php echo $_SESSION['acc_year']; ?>
                                                <!-- <input type="text" class="form-control" name="amc_year" id="amc_year"> -->
                                            </div>
                                        </div>
                                        <div class="row ">
                                            <div class="col-md-4 fm">
                                                <label for="product_category" class="form-label">DISTRICT
                                                    NAME:</label>&nbsp;&nbsp;&nbsp;
                                            ...
                                            <div class="col-md-4 fm">
                                                <label for="product_category" class="form-label">TALUK
                                                    NAME:</label>&nbsp;&nbsp;&nbsp;
                                                <?php echo $taluk_name; ?>
                                        ...
                                        <div class="col-md-2 fm">
                                            <input type="hidden"   id="entry_date" name="entry_date"  value="<?php echo $current_date; ?>">

                                            <input type="date" hidden class="form-control" name="current_date" id="current_date" required value=<?php echo $today_date; ?>>

                                            <!-- <input type="hidden"   id="current_date" name="current_date"  value="<?php echo $current_date; ?>"> -->
                                        </div>
                                    </div>
                                </div>
                                <br>
                        ...
                        <input type="hidden"  id="csrf_token" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                            ...
                                            <div class="col-md-3 fm">
                                                ...
                                                <div id="full-stars-example-two">
                                                    <div class="rating-group">
                                                        ...
                                                        <label aria-label="1 star" class="rating__label" for="rating3-1 rating"><i class="rating__icon rating__icon--star fa fa-star"></i></label>
                                            ...
                                            <div class="col-md-5 fm ">
                                                ...
                                                <textarea name="description" id="description" class="select2 form-control" oninput="description_val(this)" required><?php echo $description; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="btns mt-3">
...
<script>
    // Retrieve the rating value from PHP
    var ratingValue = <?php echo $rating; ?>;

    // Get all rating input elements
    var ratingInputs = document.querySelectorAll('.rating__input');

    // Loop through each rating input element
    ratingInputs.forEach(function(input, index) {
        // If the input value matches the rating value, check the input
