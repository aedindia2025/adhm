...
<div class=" overall-bg">
    ...
    <div class="row ">
        <div class="col-md-12 col-xl-7 col-sm-12">
            <img src="assets/images/Digital.png" width="90%">
        </div>
        <div class="col-md-12 col-xl-4 col-sm-12 input-file text-center">
            <h3>Welcome</h3>
            <p>Login into Student Account</p>
            <form class="frm-to">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    <div class="input-group input-group-merge">
                        ...
                        <input type="text" class="form-control" placeholder="Enter Captcha" name="captcha" id="captcha" required>
                        <button type="button" id="change-captcha" onclick="captch()"><i class="mdi mdi-reload"></i></button>
                    </div>
                </div>
