                                        ...
                                        <div class="row">
                                            ...
                                            <div class='col-md-4 fm'>
                                                ...
                                                <input type='file' id='image_upload' name='image_upload'
                                                    class='form-control' accept="image/*,.doc,.docx,.pdf">
                                            </div>
                                            <?php }else{?>
                                            <div class='col-md-4 fm'>
                                            ...
                                            <div class='col-md-4 fm'>
                                                ...
                                                <input type='file' id='doc_upload' name='doc_upload'
                                                    class='form-control' accept="image/*,.doc,.docx,.pdf" value="<?php echo $doc_file_name; ?>">
                                            </div>
                                            <?php }else{ ?>
                                            <div class='col-md-4 fm'>
                                            ...
                                            <div class='col-md-4 fm'>
                                                ...
                                                <input type='file' id='video_upload' name='video_upload'
                                                    class='form-control' accept="video/mp4" value="<?php echo $video_upload; ?>">
                                            </div>
                                            <?php } else{ ?>
                                            <div class='col-md-4 fm'>
