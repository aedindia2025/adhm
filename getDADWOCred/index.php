...
$sql = "SELECT 
    (SELECT district_name FROM district_name WHERE district_name.unique_id = staff_registration.district_office) as districtName,
    user_name as userName,
    password
    FROM staff_registration WHERE is_delete = 0 AND designation = '65f31975f0ce678724'";
...
if ($result->num_rows > 0) {
    ...
    echo json_encode(["status" => "Success", "data" => $credData]);
} else {
