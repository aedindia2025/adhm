...
if($_GET['taluk_name']){
    $where .= " AND taluk_office = '".$_GET['taluk_name']."'"; 
}
if($_GET['hostel_name'] && $_GET['hostel_name'] != NULL){
    $where .= " AND hostel_name = '".$_GET['hostel_name']."'"; 
}

$sql = "SELECT * FROM establishment_registration WHERE is_delete = 0 and district_office = '".$_SESSION['district_id']."' $where";
