...
switch ($action) {
    ...
    case 'createupdate':
        ...
        $dadwo_name = $_POST["dadwo_name"];
        $unique_id = $_POST["unique_id"];


        $columns = [
            "dadwo_name" => $dadwo_name,
