...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $special_tahsildar = special_tahsildar($result_values[0]["special_tahsildar"])[0]['special_tahsildar'];
                ...
                <div class="col-12">
                    <div class="card">
                                ...
                                <div class="row">
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" oninput="valid_user_name(this)" id="hostel_name" name="hostel_name"
                                                value="<?= $hostel_name; ?>" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" oninput="off_id(this)" class="form-control" id="hostel_id" name="hostel_id"
                                                value="<?= $hostel_id; ?>" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-control" id="district_name" name="district_name"
                                                onchange="get_taluk_name(); get_block(); get_assembly(); get_parliament(); get_corporation(); get_municipality(); get_town_panchayat();" required disabled>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select class="select2 form-control" id="taluk_name" name="taluk_name"required disabled>
                                 ...
                                 <input type="text" class="form-control" id="special_tahsildar"
                                                name="special_tahsildar" oninput="valid_user_name(this)" value="<?= $special_tahsildar; ?>" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="textarea" oninput="valid_address(this)" class="form-control" id="address" name="address"
                                                value="<?= $address; ?>" required disabled>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <select name="hostel_location" id="hostel_location"
                                                ...
                                                onchange="get_hostel_location_type()" disabled>
                                    ...
                                    <div class="col-md-4" id="urbanFieldsType" style="display: none;">
                                        <div class="mb-3">
                                            ...
                                            <select name="urban_type" id="urban_type" class="select2 form-control"
                                                onchange="get_urban_type()" disabled>
                                    ...
                                    <div class="col-md-4" id="corporationField" style="display: none;">
                                        <div class="mb-3">  
                                            ...
                                            <select name="corporation" id="corporation" class="select2 form-control" disabled>
                                    ...
                                    <div class="col-md-4" id="municipalityField" style="display: none;">
                                        <div class="mb-3">
                                            ...
                                            <select name="municipality" id="municipality" class="select2 form-control" disabled>
                                    ...
                                    <div class="col-md-4" id="ruralFieldsTypeVillage" style="display: none;">
                                        <div class="mb-3">
                                            ...
                                            <select name="village_name" id="village_name" class="select2 form-control" disabled>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="file" class="form-control" id="test_file" name="test_file"
                                                accept=".pdf, .doc, .docx, image/*" disabled>
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" oninput="year_only(this)" class="form-control" id="sanctioned_strength"
                                                ...
                                                maxlength="3" minlength="1" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="distance_btw_phc"
                                                ...
                                                oninput="number_only(this)" maxlength="2" minlength="1" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" oninput="valid_user_name(this)" class="form-control" id="phc_name" name="phc_name"
                                                value="<?= $phc_name; ?>" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                    ...
                                    <div class="col-md-4">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" oninput="off_id(this)" class="form-control" id="ps_name" name="ps_name"
                                                value="<?= $ps_name; ?>" required readonly>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <table id="hostel_upgrade_datatable" class="table w-100">
                                <thead>
                                    <tr>
                                        <th>S.No</th>
                                        <th>GO No</th>
