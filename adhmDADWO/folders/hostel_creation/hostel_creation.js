...
function get_upgrade_fields(){
	...
	if(hostel_upgrade == 'Yes'){
		document.getElementById('upgrade_fields').style.display = 'flex';
	}else{
...
function hostel_creation_cu(unique_id = "") {
    ...
    var sanc_staff_count 		= document.getElementById('sanc_staff_count').value;
...
// alert(hybrid_hostel);
	...
	data.append("sanc_staff_count", sanc_staff_count);
