...
$district_unique_name = $_SESSION["district_name"];
            ...
            <div class="row">
                <div class="col-10">
                    <div class="page-title-box">
                        ...
                        <h4 class="page-title">Indent Raise</h4>
                    </div>
                </div>
            </div>
            <div class="card">
                    ...
                    <form class="was-validated" autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 mb-3">
                                ...
                                <!-- <select class="form-select select2" name="district" id="district" onchange="get_taluk()">
                                    <?php echo $district_name_list; ?>
                                </select> -->
                                <input type="text" class="form-control" value="<?= $district_unique_name ?>"
                                    readonly>
                                <input type="hidden" class="form-control" name="district" id="district" value="<?= $district_unique_id ?>"
                                    readonly>
                            </div>
                            <div class="col-md-2 mb-3">
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table id="indent_raise_datatable" class="table dt-responsive nowrap w-100 mt-3">
                                <thead>
                                    <tr>
                                        <th>S.no</th>
                                        <th>Hostel ID</th>
