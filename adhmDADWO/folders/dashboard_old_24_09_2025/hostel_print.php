    ...
    <div class="container-fluid" style="background-color:#fff;">
            ...
            <div class="zone_boxbor">
                <div class="row">
                    ...
                    <div class="col-md-12">
						...
						<th width="10%" colspan="1" class="blankCell">Sanctioned Count</th>
						<th width="10%" colspan="1" class="blankCell">Applied Count</th>
						...
						"unique_id"
							...
							$sanc_cnt = sanc_cnt($value['unique_id']);
							$app_cnt = applied_cnt($value['unique_id']);
                                                    ...
                                                    $table_data .= "<td style = 'text-align : left'>" . $sanc_cnt . "</td>";
                                                    $table_data .= "<td style = 'text-align : left'>" . $app_cnt . "</td>";
        ...
        function sanc_cnt($unique_id = "")
        {
            ...
            if ($amc_name_list->status) {
                return $amc_name_list->data[0]['sanctioned_strength'];
            } else {
                print_r($amc_name_list);
                return 0;
            }
        ...
        function applied_cnt($unique_id = "")
        {
            // echo $zone_name;
           ...
           $where = "is_delete = '0' and hostel_1 = '".$unique_id."'";
            ...
            if ($amc_name_list->status) {
                return $amc_name_list->data[0]['app_cnt'];
            } else {
                print_r($amc_name_list);
                return 0;
            }
