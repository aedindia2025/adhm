    							...
    							<table cellspacing="0" cellpadding="0" class="" width="100%" style="font-family: monospace;">
    								<thead class="colspanHead">
    									<tr>
    										...
    										<th width="10%" colspan="1" class="blankCell">Reg No</th>
									...
									if ($_GET['status'] == "approved") {
										$where_list = " is_delete = 0 and status = '1' and hostel_district_1 = '".$_SESSION["district_id"]."'";
									}
									if ($_GET['status'] == "rejected") {
										$where_list = " is_delete = 0 and status = '2' and hostel_district_1 = '".$_SESSION["district_id"]."'";
									}
									if ($_GET['status'] == "acceptance") {
										$where_list = " is_delete = 0 and batch_no != '' and hostel_district_1 = '".$_SESSION["district_id"]."'";
									}
									if ($_GET['status'] == "applied") {
										$where_list = " is_delete = 0 and hostel_district_1 = '".$_SESSION["district_id"]."'";
									}
									if ($_GET['status'] == "pen_warden_pr") {
										$where_list = " is_delete = 0 and (batch_no = '' or batch_no IS NULL) and hostel_district_1 = '".$_SESSION['district_id']."'";
									}
									if ($_GET['status'] == "pen_dadwo_pr") {
										$where_list = " is_delete = 0 and status = 0 and batch_no IS NOT NULL and hostel_district_1 = '".$_SESSION['district_id']."'";
									}
									...
									$columns_list    = [
										...
										"entry_date",
										"std_app_no",
										"(select std_reg_no from std_reg_s where std_app_s.unique_id = std_reg_s.unique_id) as std_reg_no",
