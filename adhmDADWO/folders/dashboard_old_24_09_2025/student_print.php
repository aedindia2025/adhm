    					...
    					<div class="clearfix">
							<center>
											...
											<div class="col-sm-12 ">
												...
												<div class="row">
                                                <center>
                                                    <h3>REGISTERED STUDENTS</h3></center>
													<div class="col-sm-12">
    					...
    					<div class="zone_recom3">
    						<div class="box1">
    							<table cellspacing="0" cellpadding="0" class="" width="100%" style="font-family: monospace;">
									...
									$columns_list    = [
										"@a:=@a+1 s_no",
                                        "(select std_name from std_app_s2 where std_app_s2.s1_unique_id = std_reg_s.unique_id) as std_name",
                                        "std_reg_no",
                                    ...
                                    $where_list ="is_delete = 0 AND hostel_district_1 = '".$district_name."' and dropout_status = '1'";
