                            ...
                            <form>
                                <div id="basicwizard">
                                    <ul class="nav nav-pills nav-justified form-wizard-header mb-4">
                                        <li class="nav-item">
                                            <a href="#home1" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2">
                                                <i class="mdi mdi-account-circle font-18 align-middle me-1"></i>
                                                <span class="d-none d-sm-inline">Hostel Info</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#profile1" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2">
                                                <i class="mdi mdi-face-man-profile font-18 align-middle me-1"></i>
                                                <span class="d-none d-sm-inline">Land Details</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#settings1" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2">
                                        ...
                                        <li class="nav-item">
                                            <a href="#settings2" data-bs-toggle="tab" data-toggle="tab" class="nav-link rounded-0 py-2">
                                                <i class="mdi mdi-checkbox-marked-circle-outline font-18 align-middle me-1"></i>
                                        ...
                                        <div class="tab-pane active" id="home1">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 fm">
                                                            <label for="example-select" class="form-label">Acadamic
                                                                Year</label>
                                                            <select class="form-select" id="acc_year" name="acc_year" disabled>
                                                                <?php echo $academic_year_options; ?></select>
                                                        </div>
                                                        <div class="col-md-12 fm">
                                                            <label for="simpleinput" class="form-label">Hostel
                                                                Name</label>
                                                            <input type="text" class="form-control" id="hostel_name" name="hostel_name" value="<?php echo   $_SESSION['hostel_name']; ?>" readonly>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="row">
                                                        <div class="col-md-12 fm">
                                                            <label for="simpleinput" class="form-label">Hostel
                                                                ID</label>
                                                            <input type="text" class="form-control" id="hostel_id" name="hostel_id" value="<?php echo $_SESSION['hostel_main_id']; ?>" readonly>
                                                            <input type="hidden" id="unique_id" name="unique_id" class="form-control" value="<?php echo $unique_id; ?>">

                                                            <input type="hidden" id="update_unique_id" name="update_unique_id" value="<?php echo $m_unique_id; ?>">
                                                        </div>
                                                        <div class="col-md-12 fm">
                                                            <label for="example-select" id="taluk" name="taluk" class="form-label">Taulk</label>
                                                            <input type="text" class="form-control" value="<?php echo $_SESSION['taluk_name']; ?>" readonly>
                                                        </div>
                                                ...
                                                <div class="col-md-6 fm">
                                                    ...
                                                    <input class="form-control" id="district" name="district" value="<?php echo $_SESSION['district_name']; ?>" readonly>
                                                </div>
                                                <input type="hidden" id="district_id" name="district_id" class="form-control" value="<?php echo  $_SESSION["district_id"]; ?>">

                                                <input type="hidden" id="taluk_id" name="taluk_id" class="form-control" value="<?php echo  $_SESSION["taluk_id"]; ?>">

                                                <input type="hidden" id="hostel_unique_id" name="hostel_unique_id" class="form-control" value="<?php echo  $_SESSION["hostel_id"]; ?>">
                                            </div>
                                        ...
                                        <div class="tab-pane" id="profile1">
                                            <div class="row">
                                                <div class="col-md-5 fm">
                                                    <label for="example-select" class="form-label">Having own land / Not having own land</label>
                                                    <select name="land_type" id="land_type" class="select2 form-control" required onchange="changeLandType()">
                                            ...
                                            <div id="own_land_div" style="display:none;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3 fm">
                                                        <label for="example-select" class="form-label">Owner of the land</label>
                                                        <select name="owner_of_land" id="owner_of_land" class="select2 form-control" required>
                                                            <?php echo $owner_of_land_options; ?>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label for="simpleinput" class="form-label">A-Register of the land</label>
                                                        <input type="text" id="reg_of_land" name="reg_of_land" class="form-control" value="<?php echo $reg_of_land; ?>">
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Doc Upload</label>
                                                        <input class="form-control" type="file" id="doc_file" name="doc_file" accept=" .doc, .docx, .pdf, .txt, image/* ">
                                                        <input class="form-control" type="hidden" id="land_pic" name="land_pic" value="<?= $land_doc_name;?>">

                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Total Area of land</label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="area_of_land" name="area_of_land" onkeypress="number_only(event);" value="<?php echo $area_of_land; ?>">
                                                    ...
                                                    <div class="col-md-3 fm">
                                                        ...
                                                        <div class="input-group">
                                                            <input type="text" class="form-control" id="con_area_land" name="con_area_land" onkeypress="number_only(event);" value="<?php echo $con_area_land; ?>">
                                                            <span class="input-group-text">sq ft</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            ...
                                            <ul class="pager wizard mb-0 list-inline">
                                                <li class="previous list-inline-item">
                                                    <button type="button" class="btn btn-light">Back <i class="mdi mdi-arrow-left me-1"></i></button>
                                                </li>
                                                <li class="next list-inline-item float-end">
                                                    <button type="button" class="btn btn-info">Next <i class="mdi mdi-arrow-right ms-1"></i></button>
                                                </li>
                                        ...
                                        <div class="tab-pane" id="settings1">
                                            <div class="row">
                                                <div class="col-md-4 fm">
                                                    <label for="existing_demolished" class="form-label">Existing or Demolished</label>
                                                    <select name="existing_demolished" id="existing_demolished" class="select2 form-control" onchange="exisiting_demolished(this)" required>
                                                ...
                                                <div class="col-md-4 fm" id="demolished_div" style="display: none;">
                                                    ...
                                                    <select name="demolished" id="demolished" class="select2 form-control" required>
                                                ...
                                                <div class="col-md-4 fm" id="compound_waal_div" style="display: none;">
                                                    ...
                                                    <select name="compound_wall" id="compound_wall" class="select2 form-control" required>
                                                ...
                                                <div class="col-md-4 fm" id="water_fac_div" style="display: none;">
                                                    ...
                                                    <select name="water_facilities" id="water_facilities" class="select2 form-control" required>
                                            ...
                                            <div id="ground_floor_div" style="display:none">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-3 fm" id="no_floor_div">
                                                        ...
                                                        <select name="no_floors" id="no_floors" class="select2 form-control" required>
                                                            <?php echo $no_floors_options; ?>
                                                        </select>
                                                    </div>
                                                    <div class="col-md-3 fm" id="no_toilet_div">
                                                        <label class="form-label">Number of toliet</label>
                                                        <input type="text" id="toilet_each_floor" name="toilet_each_floor" class="form-control" onkeypress="number_only(event);" minlength="1" maxlength="3" value="<?php echo $toilet_each_floor; ?>">
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Number of living area</label>
                                                        <input type="text" id="living_area" name="living_area" class="form-control" onkeypress="number_only(event);" minlength="1" maxlength="3" value="<?php echo $living_area; ?>">
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Living Area Size</label>
                                                        <div class="input-group">
                                                            <input type="text" id="living_area_size" name="living_area_size" class="form-control" onkeypress="number_only(event);" value="<?php echo $living_area_size; ?>">
                                                            <span class="input-group-text">sq ft</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Number of Rooms</label>
                                                        <input type="text" id="no_of_rooms" name="no_of_rooms" class="form-control" onkeypress="number_only(event);" minlength="1" maxlength="3" value="<?php echo $no_of_rooms; ?>">
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Room Size</label>
                                                        <div class="input-group">
                                                            <input type="text" id="room_size" name="room_size" class="form-control" onkeypress="number_only(event);" value="<?php echo $room_size; ?>">
                                                            <span class="input-group-text">sq ft</span>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Number of Kitchen</label>
                                                        <input type="text" id="no_of_kitchen" name="no_of_kitchen" class="form-control" onkeypress="number_only(event);" minlength="1" maxlength="3" value="<?php echo $no_of_kitchen; ?>">
                                                    </div>
                                                    <div class="col-md-3 fm">
                                                        <label class="form-label">Kitchen Size</label>
                                                        <div class="input-group">
                                                            <input type="text" id="kitchen_size" name="kitchen_size" class="form-control" onkeypress="number_only(event);" value="<?php echo $kitchen_size; ?>">
                                                            <span class="input-group-text">sq ft</span>
                                                        </div>
                                                    </div>
                                                    <div>
                                                        <button class="btn" type="button" onclick="buildings_sub_add_update()">Save</button>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row" id="datatableSub" style="display:none">
                                                <br>
                                                <div class="col-12">
                                                    <table id="buildings_sub_datatable" class="table dt-responsive nowrap w-100">
                                                        <thead>
                                                            <tr>
                                                                <th>S.no</th>
                                                                <th>Floor</th>
                                            ...
                                            <ul class="pager wizard mb-0 list-inline mt-1">
                                                <li class="previous list-inline-item">
                                                    <button type="button" class="btn btn-light"><i class="mdi mdi-arrow-left me-1"></i> Back
                                                    </button>
                                                </li>
                                                <li class="next list-inline-item float-end">
                                                    <button type="button" class="btn btn-info">Next <i class="mdi mdi-arrow-right ms-1"></i></button>
                                        ...
                                        <div class="tab-pane" id="settings2">
                                            <div class="row">
                                                <div class="col-md-4 fm">
                                                    ...
                                                    <select name="facilities_type" id="facilities_type" class="form-control" required onchange="get_asset_name()">
                                                        <?php echo $facility_type_options; ?>
                                                    </select>
                                                </div>
                                                <div class="col-md-4 fm">
                                                    <label for="example-select" class="form-label">Facility Name</label>
                                                    <select name="facilities" id="facilities" class="form-control" required>
                                                        <?php echo $facility_name_options; ?>
                                                    </select>
                                                </div>
                                                <div class="col-md-4 fm">
                                                    <label class="form-label">Quantity</label>
                                                    <input type="text" id="quantity" name="quantity" minlength="1" maxlength="3" onkeypress="number_only(event);" class="form-control">
                                                </div>
                                                <div class="col-md-4 fm">
                                            ...
                                            <div>
                                                <button class="btn" type="button" onclick="save_facilities()">Save</button>
                                            </div>
                                            <div class="row">
                                                <br>
                                                <div class="col-12">
                                                    <table id="digital_infra_datatable" class="table dt-responsive nowrap w-100">
                                                        <thead>
                                                            <tr>
                                                                <th>S.No</th>
                                                                <th>Facility Type</th>
                                            ...
                                            <ul class="pager wizard mb-0 list-inline mt-1">
                                                ...
                                                <?php echo btn_cancel($btn_cancel); ?>
                                                    <button type="button" class="btn btn-info" onclick="digital_infrastructure_cu()">Submit</button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div> <!-- tab-content -->
