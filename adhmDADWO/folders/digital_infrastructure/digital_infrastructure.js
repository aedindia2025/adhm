...
function digital_infrastructure_cu(unique_id = "") {
	...
	var hostel_name = document.getElementById('hostel_unique_id').value;
	var hostel_id = document.getElementById('hostel_id').value;
	var taluk_name = document.getElementById('taluk_id').value;
	...
	var land_pic = document.getElementById("land_pic").value;
...
// function facility_type(eve) {

// 	var facilities = $('#facilities_type').val();
// 	// alert(facilities);
// 	var data = "facility_type=" + facilities + "&action=facilities";
// 	var ajax_url = sessionStorage.getItem("folder_crud_link");
// 	$.ajax({
// 		type: "POST",
// 		url: ajax_url,
...
// 				if (facilities == "digital_facility") {
// 					$('#facility_title1').show();
// 					$('#facilities_div').show();
// 					$('#facility_title').hide();
// 				} else {
// 					$('#facility_title').show();
// 					$('#facilities_div').show();
// 					$('#facility_title1').hide();
// 				}
// 			}
// 		}
// 	});
...
function save_facilities() {
	...
	var data = "facilities_type=" + facilities_type + "&facilities=" + facilities + "&quantity=" + quantity + "&description=" + description;
