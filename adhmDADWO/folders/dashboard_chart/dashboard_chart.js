...
var root; // Declare a global variable for the root object
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            am5.ready(function() {
                ...
                root = am5.Root.new("datewise_chart");
                root._logo.dispose();
...
var root_count;  // Global variable to store the root instance
...
function student_count() {
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            am5.ready(function () {
                if (root_count) {
                    root_count.dispose();  // Dispose of any previous instance
                }

                root_count = am5.Root.new("student_chart");  // Correct initialization

                root_count._logo.dispose();  // Remove amCharts logo

                root_count.setThemes([am5themes_Animated.new(root_count)]);  // Apply themes

                // Create the chart
                var chart = root_count.container.children.push(am5xy.XYChart.new(root_count, {
                    panX: true,
                    panY: false,
                    wheelX: "panX",
                    wheelY: "zoomX",
                    paddingLeft: 0,
                    layout: root_count.verticalLayout  // Ensure this uses root_count
                }));
                ...
                chart.set("scrollbarX", am5.Scrollbar.new(root_count, {
                    orientation: "horizontal"
                }));

                var xRenderer = am5xy.AxisRendererX.new(root_count, {
                    minGridDistance: 8,
                    minorGridEnabled: true
                });
                ...
                xRenderer.labels.template.setAll({
                    ...
                    fill: am5.color(0x000000) // Adjust text color if needed
                });

                // Create the X-axis
                var xAxis = chart.xAxes.push(am5xy.CategoryAxis.new(root_count, {
                    categoryField: "district_name",
                    renderer: xRenderer,
                    tooltip: am5.Tooltip.new(root_count, {
                        themeTags: ["axis"],
                        animationDuration: 200
                    })
                }));
                ...
                // Create the Y-axis
                var yAxis = chart.yAxes.push(am5xy.ValueAxis.new(root_count, {
                    min: 0,
                    renderer: am5xy.AxisRendererY.new(root_count, {
                        strokeOpacity: 0.1
                    })
                }));

                // Series for cnt
                var series0 = chart.series.push(am5xy.ColumnSeries.new(root_count, {
                    name: "District Name",
                    xAxis: xAxis,
                    yAxis: yAxis,
                    valueYField: "cnt",
                ...
                // Add cursor
                var cursor = chart.set("cursor", am5xy.XYCursor.new(root_count, {}));
...
function occupancy_chart_data() {
    ...
    $.ajax({
        ...
        success: function (responseData) {
            ...
            var chart = new ApexCharts(document.querySelector("#actualchart_1"), options);
            chart.render();
        },
        error: function (xhr, status, error) {
