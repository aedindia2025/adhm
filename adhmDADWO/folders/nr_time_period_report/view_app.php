                ...
                <div class="mt-0 float-sm-left">
                    <div class="row">
                        ...
                        <?php if ($std_orphan == 'NO') { ?>
                            ...
                            <div class="col-sm-4">
                                <p class="font-12">Mother Name: <strong><?= $std_mother_name_s6; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">Father Qualification: <strong><?= $std_father_qual_s6; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">Mother Qualification: <strong><?= $std_mother_qual_s6; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">Father Occupation: <strong><?= $std_father_occu_s6; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                                <p class="font-12">Mother Occupation: <strong><?= $std_mother_occu_s6; ?></strong></p>
                            </div>
                        <?php   } ?>
