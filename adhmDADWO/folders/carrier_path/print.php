        ...
        <div class="col-sm-12 ">
            <div class="mt-0 float-sm-left">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <p class="font-13">Accademic Year: <strong><?= $result_values["acc_yr"]; ?></strong></p>
                    </div>
                    <div class="col-sm-6">
                    ...
                    <div class="col-sm-6">
                        <p class="font-13">District Name: <strong><?= $district_name; ?></strong></p>
                    </div>
                    <div class="col-sm-6">
                        <p class="font-13">Taluk Name: <strong><?= $taluk_name; ?></strong></p>
                    </div>
                    <div class="col-sm-6">
                        <p class="font-13">Hostel Name: <strong><?= $hostel_name; ?></strong></p>
                    </div>
                    <!-- <div class="col-sm-6">
