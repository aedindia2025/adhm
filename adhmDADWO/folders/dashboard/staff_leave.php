                                    ...
                                    <table cellspacing="0" cellpadding="0" class="" width="100%" style="font-family: monospace;">
                                        <thead class="colspanHead">
                                            <tr>
                                                ...
                                                <th width="10%" colspan="1" class="blankCell">Staff ID</th>
                                        ...
                                        $where_list = "is_delete = 0 AND district_name = '" . $district_name . "'";
