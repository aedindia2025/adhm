...
function new_external_window_filter(event, url, status) {
    ...
    var link = url + '?status=' + status + '&district_name=' + district_name + '&taluk_name=' + taluk_name + '&hostel_name=' + hostel_name + '&hostel_type=' + hostel_type + '&gender_type=' + gender_type;
    // window.location=link;
    onmouseover = window.open(link, 'onmouseover', 'height=550,width=950,resizable=no,left=200,top=150,toolbar=no,location=no,directories=no,status=no,menubar=no');
}
