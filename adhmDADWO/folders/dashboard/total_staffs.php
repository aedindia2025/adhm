					...
					<div class="clearfix">
						...
						<div class="col-sm-12 ">
							<div class="mt-0 float-sm-left">
								<div class="row">
									<center>
										<h3>ESTABLISHMENT STAFF</h3>
									</center>

									<div class="col-sm-12">
										<!-- <p class="font-12">Hostel District   :  &nbsp;<strong><?php echo $_SESSION['district_name']; ?></strong></p> -->
									</div>

									<div class="col-sm-12">
										<!-- <p class="font-12">Date   :  &nbsp;<strong><?php echo date('d-m-Y'); ?></strong></p> -->
									</div>
							...
							<div class="box1">
								<table cellspacing="0" cellpadding="0" class="" width="100%"
									...
									$columns_list = [
										'@a:=@a+1 s_no',
										'staff_name',
										"(select designation_name from designation_creation where unique_id = $table.designation AND district_office = '" . $district_name . "')as designation",
										"(select hostel_name from hostel_name where unique_id =$table.hostel_name AND district_office = '" . $district_name . "')as hostel_name",
										"(select district_name from district_name where unique_id = $table.district_office AND district_office = '" . $district_name . "')as district_name",
										"(select taluk_name from taluk_creation where unique_id = $table.taluk_office AND district_office = '" . $district_name . "')as taluk_name",
									];
									...
									if ($result->status) {
										...
										if (count($res_array) == 0) {
											...
											foreach ($res_array as $key => $value) {
												...
												$table_data .= "<td style = 'text-align : left'>" . $value['district_name'] . '</td>';
