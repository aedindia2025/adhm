...
$hostel_gender_list = select_option($hostel_gender_list, "Select Gender Type", $hostel_gender);
?>
        ...
        <div class="container-fluid">
            ...
            <div class="row mb-3">
                <div class="col-md-3 fm">
                    ...
                    <input type="text" class="form-control" name="" id="" value="<?= $_SESSION['district_name'] ?>"
                        readonly>
                </div>
                <div class="col-md-3 fm">
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="card tilebox-one bb-1">
                        ...
                        onclick="new_external_window_filter(event,'folders/dashboard/total_students.php');"
