...
$from_year = '2020';
$to_year = '2021';
$user_type_unique_id = '65eee47e6709453983';
        ...
        if ($extracted_token == $token) {
            ...
            if ($captcha == $_SESSION['captcha_text'] && $captcha != '') {
                $columns = [
                    ...
                    'mobile_num',
                    'email_id',
                    '(SELECT district_name FROM district_name WHERE district_name.unique_id = ' . $table . '.district_name) as district_addr',
                ...
                if ($action_obj->status) {
                    ...
                    if ($count_data == 1) {
                        ...
                        $_SESSION['district_adrss'] = $user['district_addr'];
