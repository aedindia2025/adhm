...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        $columns = [
            "(select std_reg_no from std_reg_s where std_reg_s.unique_id = $table.student_id)as student_id",
            "student_name",
            "dropout_reason",
            ...
            "(select hostel_id from hostel_name where hostel_name.unique_id=$table.hostel_id) as hostel_id",
            "cust_reason",
        ...
        if ($result_values->status) {
            ...
            // echo $student_id;
if($dropout_reason == '673f05bd7d90c91668'){
    $reason = $cust_reason;
}else{
    $reason = dropout_reason($dropout_reason)[0]['dropout_reason'];
}
    ...
    <div class="row">
        <div class="col-sm-12 mb-2">
            <div class="mt-2" style="text-align:center;">
                <h5><b>Student Dropout / Discontinue</b></h5>
            </div>
            <br>
        ...
        <div class="col-sm-12 ">
            <div class="mt-0 float-sm-left">
                <div class="row">
                    <div class="col-sm-6">
                        <p class="font-12">Initiated Date: <strong><?= $created; ?></strong></p>
                    </div>
                    <div class="col-sm-6">
        ...
        <div class="col-sm-12 ">
            <div class="mt-0 float-sm-left">
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        <p class="font-12">Student Registration Number: <strong><?= $student_id; ?></strong></p>
                    </div>
                    <div class="col-sm-6">
                        <p class="font-12">Student Name: <strong><?= $student_name; ?></strong></p>
                    </div>
                    <div class="col-sm-6">
                        <p class="font-12">Reason for Dropout / Discontinue: <strong><?= $reason; ?></strong></p>
                    </div>
                </div>
            </div>
        </div><!-- end col -->
