...
<br>
                                                <div class="col-md-6 fm">
                                                    ...
                                                    <input type="hidden" class="form-control" id="pic" name="pic" value="<?= $file_name; ?>" required>
                                                    ...
                                                    <!-- <input type="text" class="form-control" id="taluk_name" name="taluk_name" value="<?= $_SESSION['taluk_id'];?>" required> -->
