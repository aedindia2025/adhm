                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-12">
                                                <div class="row mt-3">
                                                    ...
                                                    <div class="col-md-4 mb-3 mt-3"><label for="std_app_no" class="form-label2">Application Number : <span id="std_app_no" name="std_app_no" class="tag spe-h5"><?php echo $std_app_no; ?></span></label>
                                                    </div>
                                                    <div class="col-md-4 mb-3 mt-3">
