                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6 fm ">
                                                            <label for="simpleinput" class="form-label">Aadhar
                                                                Number</label>
                                                            <input type="text" id="aadhaar_no" required name="aadhaar_no" max="12" class="form-control" value="<?php echo $aadhaar_no; ?>">
                                                        </div>
                                                        <div class="col-md-6 fm ">
                                                            <div class="">
                                                                <label class="form-label" for="example-select">E-mail
                                                                    Id</label>
                                                                <input type="text" class="form-control" id="email_id" required name="email_id" onchange="validateEmail()" value="<?php echo $email_id; ?>">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-6 fm">
