                                    ...
                                    <form class='was-validated' autocomplete='off'>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class='col-md-4 fm'>
                                                ...
                                                <!-- <img class="img-fluid" src="assets/images/carrier_guidance/images/<?php echo $image_file_name; ?>" width="33%"> -->
                                            </div>
                                            <?php } if($doc_file_name == ''){?>
                                            <div class='col-md-4 fm'>
                                                <label class='form-label'>Document Upload</label>
                                                <input type='file' id='doc_upload' name='doc_upload'
                                                    class='form-control' value="<?php echo $doc_file_name; ?>" accept=".doc, .docx, .pdf, .txt, image/*">
                                            </div>
                                            <?php }else{ ?>
                                            <div class='col-md-4 fm'>
                                            ...
                                            <div class='col-md-4 fm'>
                                                ...
                                                <input type='file' id='video_upload' name='video_upload'
                                                    class='form-control' value="<?php echo $video_upload; ?>" accept="video/mp4">
                                            </div>
                                            <?php } else{ ?>
                                            <div class='col-md-4 fm'>
