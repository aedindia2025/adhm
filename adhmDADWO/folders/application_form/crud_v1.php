...
switch ($action) {
    ...
    case 'get_unique_id':
        ...
        $sql = "SELECT unique_id FROM $table WHERE is_delete = ? AND uuid = ?";
        ...
        $password = '3sc3RLrpd17';
            ...
            $unique_id = base64_encode(openssl_encrypt($unique_id, $enc_method, $enc_password, OPENSSL_RAW_DATA, $enc_iv));
    ...
    case 'edit_aad_otp_verify':
        ...
        // $url = ' https://tnauth.tn.gov.in/clientgwapi/api/Aadhaar/KYCWithOTPP';
    ...
    case 'edit_already_uuid':
        ...
        // Prepare the SQL statement
        $sql = "SELECT COUNT(unique_id) AS count,batch_no FROM $table WHERE is_delete = ? AND uuid = ? and student_status = 2";
        $stmt = $mysqli->prepare($sql);
    ...
    case 'edit_check_aadhar':
        ...
        //$url = 'https://tnauth.tn.gov.in/auakua25dvuat/api/datavault/InsertUID?UIDToken&AadhaarNo=' . $edit_aadhar_no . '&APPKey=MQOOT-BXPBZ-COZRJ-UGHZQ';
