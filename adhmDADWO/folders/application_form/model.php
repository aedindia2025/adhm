...
if (isset($_GET["unique_id"])) {
	...
	if (!empty($_GET["unique_id"])) {
		...
		if ($result_values_1->status) {
			...
			$student_status = $result_values[0]["student_status"];
...
// print_r($result_values_aadhar);die();
...
// print_r($result_values2);die();
		if ($result_values2->status) {
			...
			$srilankan_id_no = $result_values[0]["srilankan_id_no"];
			$std_image = $result_values[0]["std_image"];
...
// print_r($result_values3);
		...
		$result_values_emis3 = $pdo->select($table_details_emis3, $where_emis3);

		if ($result_values_emis3->status) {

			$result_values = $result_values_emis3->data;


			$udise_code = $result_values[0]["udise_code"];
			$emis_father_occupation = $result_values[0]["father_occupation"];
			$emis_mother_occupation = $result_values[0]["mother_occupation"];
			$class_section = $result_values[0]["class_section"];
			$community_name = $result_values[0]["community_name"];
			$group_code_id = $result_values[0]["group_code_id"];
			$emis_father_name = $result_values[0]["father_name"];
			$emis_mother_name = $result_values[0]["mother_name"];
		...
		if ($result_values4->status) {
			...
			$no_umis_branch = $result_values[0]["no_umis_branch"];
			$no_umis_inst_id = $result_values[0]["no_umis_inst_id"];
			...
			if($no_umis_course){
			$course_name_options = course_name_options("", $no_umis_stream);
			$course_name_options = select_option($course_name_options, "Select Degree", $no_umis_course);
			}else{
				$course_name_options = "<option value=''>Select Degree</option>";
			}

			if($no_umis_branch){
			$course_branch_options = course_branch_options("", $no_umis_course);
			$course_branch_options = select_option($course_branch_options, "Select Branch", $no_umis_branch);
			}else{
				$course_branch_options = "<option value=''>Select Branch</option>";
			}
		...
		if ($result_values5->status) {
			...
			$input_status = $result_values[0]["input_status"];
...
if($no_umis_inst_id){
$institute_id_options = institute_id();
$institute_id_options = select_option($institute_id_options, "Select Institute", $no_umis_inst_id);
}else{
	$institute_id_options = "<option value=''>Select Institute</option>";
} 
...
<div class="content-page">
						...
						<div id="btnwizard">
							<ul class="nav nav-tabs  mb-3 new-tabdesig" role="tablist">
								<li class="nav-item ds" role="presentation">
									<a href="#tab12" data-bs-toggle="tab" data-toggle="tab" class="nav-link  active"
										id="tab12-tab" aria-controls="tab12" aria-selected="true" role="tab">

										<span class="d-none d-sm-block">ஆதார் உறுதிப்படுத்தல்<br> Aadhaar
											Confirmation</span>
									</a>
								</li>
								<li class="nav-item ds" role="presentation">
									<a href="#tab22" data-bs-toggle="tab" class="nav-link" id="tab22-tab"
										aria-controls="tab22" aria-selected="false" tabindex="-1" role="tab">
								...
								<li class="nav-item ds" role="presentation">
									<a href="#tab33" data-bs-toggle="tab" data-toggle="tab" class="nav-link"
										id="tab33-tab" aria-controls="tab33" aria-selected="false" tabindex="-1"
										role="tab">

										<span class="d-none d-sm-block">சாதி & வருமானச் சான்றிதழ் <br> Community &
											Income
											Certificate</span>
									</a>
								</li>
								<li class="nav-item ds" role="presentation">
									<a href="#tab34" data-bs-toggle="tab" data-toggle="tab" class="nav-link"
										aria-selected="false" tabindex="-1" role="tab">

										<span class="d-none d-sm-block"> குடும்பம் மற்றும் சுயவிவரம் <br> Family &
											Personal info
										</span>
									</a>
								</li>
								<li class="nav-item ds" role="presentation">
									<a href="#tab35" data-bs-toggle="tab" data-toggle="tab" class="nav-link "
										aria-selected="false" tabindex="-1" role="tab" disabled
										onclick="hostelChoice();">
							...
							<div class="col-md-6">
								<div class="row">
										...
										<div class="col-md-6  normal-imput">
											<div class="row">
												<?php if ($student_status == 1) { ?>
													<div class="col-md-6">
														<label class="form-label" for="userName2">இலங்கை அடையாள எண் /
															Srilankan ID No</label>
													</div>
													<div class="col-md-6">
														<input type="text" id="srilankan_id_no"
															
															value="<?php echo $srilankan_id_no; ?>" class="form-control">
													</div>
												<?php } ?>

												<?php if ($student_status == 1) { ?>
													<div class="col-md-6">
														<label class="form-label" for="userName2">மாணாக்கரின் முழுப் பெயர் /
												...
												<?php } else { ?>
													...
													<div class="col-md-6">
														<label class="form-label" for="userName2">மாணாக்கரின் முழுப் பெயர் /
															Student Full Name (As per Aadhaar)</label>
													</div>
												<?php } ?>

												<div class="col-md-6">
													<input type="text" id="std_name" oninput="valid_user_name(this)"
														value="<?php if ($student_status == 1) {
															echo $std_name;
														} else {
															echo $aname;
												...
												<?php if ($student_status == 1) { ?>
													<div class="col-md-6">
														...
														<label class="form-label" for="userName2">புகைப்படம் பதிவேற்று /
												...
												<div class="col-md-6">
													<?php if ($student_status != 1) { ?>
														<input type="text" id="std_dob" value="<?= $adob; ?>"
															class="form-control" readonly min="1980-01-01">
													<?php } else { ?>
														<input type="date" id="std_dob" value="<?= $std_dob; ?>"
															class="form-control" min="1980-01-01">
													<?php } ?>
												</div>
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<?php if ($student_status != 1) { ?>
														<input type="text" id="std_gender" class="form-control" <?php echo $readonly; ?> value="<?php echo $agender; ?>">
													<?php } else { ?>
												...
												<?php if ($student_status == 1) { ?>
													<div class="col-md-6">
														...
														<label class="form-label" for="userName2">
															மாணாக்கரின் கைப்பேசி எண்ணினை பதிவிடவும் / Enter Student
															Mobile Number</label>
													</div>
												<?php } else { ?>
													<div class="col-md-6">
														<label class="form-label" for="userName2">ஆதாருடன் இணைக்கப்பட்ட
															மாணாக்கரின் கைப்பேசி எண்ணினை பதிவிடவும் / Enter the Student
															Aadhaar Linked Mobile Number</label>
													</div>
												<?php } ?>

												<div class="col-md-6">
													<input type="text" id="std_mobile_no" class="form-control"
														maxlength="10" oninput="valid_mobile_number(this)"
														value="<?= $std_mobile_no; ?>">
													<span class="error-message text-danger"
														id="error-std-mob-no"></span>
												</div>
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<input type="text" id="father_name" class="form-control"
														oninput="valid_user_name(this)" <?php echo $readonly; ?>
														value="<?= $father_name; ?>">
												</div>
										...
										<div class="col-md-6  normal-imput">
											<div class="row ">
												<div class="col-md-12 " style="text-align: end;">
													<label class="form-label mb-align" for="userName2">விண்ணப்ப எண் /
														Application No
														: <span
									...
									<div class="col-md-6">
												...
												<?php } else { ?>
													<div class="col-md-4 mt-2 mb-2 appli">
														<div class="boc-app">
															<div class="">
																<?php if ($std_image) { ?>
																	<img id="img_preview" src="../uploads/<?php echo $std_image; ?>"
																		class=" avatar-lg img-thumbnail" alt="profile-image">
																<?php } else { ?>
																	<img id="img_preview" src="assets/images/No_Image_Available.jpg"
																		class=" avatar-lg img-thumbnail" alt="profile-image">
																<?php } ?>
																<h4 class="mb-0 mt-2">விண்ணப்பதாரர் புகைப்படம்</h4>
																<p class="text-muted font-14">Applicant Photo</p>
													...
													<div>
														...
														<div class="box-contents">
															<div id="audit-trail">
																<ul>
																	<li>
																		<p>Please note that all communication will be
																			sent to your
																			Aadhar
																			Linked phone number</p>
																	</li>
																	<li>
																		<p style="margin-bottom: 6px;">Please ensure
																			your Bank
																			account is
										...
										<div class="col-md-12 mt-0">
											<div class="form-check form-check-inline">
												...
												<input type="checkbox" class="form-check-input" id="first_check"
													name="first_check" onclick="get_first_check(this.value)"
													value="YES">
											</div>
										</div>
									...
									<div class="float-start mt-3">
										...
										<input type="button" class="btn btn-info button-previous disabled"
										...
										<div class=" ">
											...
											<div>
												<div class="">
													<div class="row spel-app">
														<div class="col-md-6 normal-imput">
															<div class="row">
																<div class="col-md-6 ">
																	<label class="form-label" for="userName2">தங்களின்
																		EMIS எண்ணினை பதிவிடவும் / Enter your EMIS
																		ID</label>
																</div>
																...
																<div class="col-md-12">
																	<small class="mt-3">Please see EMIS Id in school id
																		card and
														...
														<div class="col-md-2">
															<input type="button" data-bs-toggle="modal"
																...
																onclick="emis_already()" value="Go">
														</div>
														<div class="col-md-4" id="emis_cancel" style="display: none;">
												...
												<div class="row spel-app mt-2" id="hiddenDiv" style="display: none;">
													<div class="col-md-6 normal-imput">
														<div class="row">
															<input type="hidden" id="emis_father_name" class="form-control" value="<?=$emis_father_name?>">
												<input type="hidden" id="emis_mother_name" class="form-control" value="<?=$emis_mother_name?>">
												<input type="hidden" id="emis_father_occupation" class="form-control" value="<?=$emis_father_occupation?>">
												<input type="hidden" id="emis_mother_occupation" class="form-control" value="<?=$emis_mother_occupation?>">
												<input type="hidden" id="group_code_id" class="form-control" value="<?=$group_code_id?>">
												<input type="hidden" id="community_name" class="form-control" value="<?=$community_name?>">
												<input type="hidden" id="class_section" class="form-control" value="<?=$class_section?>">
												<input type="hidden" id="udise_code" class="form-control" value="<?=$udise_code?>">
															<div class="col-md-6">
																<label class="form-label" for="userName2"> மாணாக்கரின்
																	முழுப் பெயர் / Student Full Name (As per EMIS)
																</label>
															</div> 
															<div class="col-md-6">
																<input type="text" id="emis_name" class="form-control"
																	oninput="valid_user_name(this)"
																	value="<?= $emis_std_name; ?>" readonly>
															</div>
															...
															<div class="col-md-6">
																<input type="date" id="emis_dob" class="form-control"
																	value="<?= $emis_std_dob; ?>" readonly>
															</div>
															<div class="col-md-6">

																<label class="form-label" for="userName2">மாணகக்கர்
																	தற்பொழுது பயிலும் வகுப்பு / Student current studying
																	standard</label>
															</div>
															<div class="col-md-6">
															...
															<div class="col-md-6">
																...
																<label class="form-label" for="userName2"
																	id="group_lbl">குழு பெயர்
																	/ Group
																	name</label>
															</div>
															<div class="col-md-6">
																<input type="text" id="emis_group" class="form-control"
																	value="<?= $group_name; ?>" readonly>
													...
													<div class="col-md-6  normal-imput">
														<div class="row ">
															<div class="col-md-6">
																<label class="form-label" for="userName2">வகை / Medium
																</label>
															</div>
															<div class="col-md-6">
															...
															<div class="col-md-6">
																<label class="form-label" for="userName2">பள்ளியின்
																	பெயர் / School Name</label>
															</div>
															<div class="col-md-6">
																<input type="text" id="emis_school_name"
																	class="form-control" value="<?= $school_name; ?>"
																	readonly>
															</div>

															<div class="col-md-6">
																<label class="form-label" for="userName2">பள்ளித் தொகுதி
																	/ School
																	Block </label>
															</div>
															<div class="col-md-6">
																<input type="text" id="emis_school_block"
																	class="form-control" value="<?= $school_block; ?>"
																	readonly>

															</div>
															<div class="col-md-6">
																<label class="form-label" for="userName2">பள்ளி மாவட்டம்
																	/ School
																	District</label>
															</div>
															<div class="col-md-6">
																<input type="text" id="emis_school_district"
																	class="form-control"
																	value="<?= $school_district; ?>" readonly>
															</div>
													...
													<div class="col-md-12 mt-0">
														<div class="form-check form-check-inline">
															<label class="form-check-label" for="customCheck3">I confirm
																that the
																above details
																are mine and correct</label>
															<input type="checkbox" class="form-check-input"
																id="emis_check" name="emis_check"
																onclick="get_emis_check()" value="YES">
														</div><br><br>
													...
													<div class="buttn">
														<div class="float-end mt-3">
															<input type="button" class="btn btn-info" name="next"
																value="Save & Continue" id="emis_btn"
																onclick="emis_details_add()" disabled>
										...
										<div>
											<div class="">
												<div class="row spel-app mt-3 ">
													<div class="col-md-12 normal-imput">
														...
														<div class="row" id="yr_std_div">
															<div class="col-md-6">
																<label class="form-label" for="userName2">நீங்கள்
																	கல்லூரியில் தற்பொழுது பயிலும் ஆண்டு? / Which year
																	are you currently studying in the college? </label>
															</div>
															<div class="col-md-4">
																<select class="form-select" id="yr_stdy"
																	onchange="get_lat_div()">
																	<option value="">Select</option>
																	<option value="1" <?php if ($year_studying == "1") {
																		echo "selected";
																	} ?>>முதலாம் ஆண்டு (First Year)
																	</option>
																	<option value="2" <?php if ($year_studying == "2") {
																		echo "selected";
																	} ?>>இரண்டாம் ஆண்டு (Second
																		Year)</option>
																	<option value="3" <?php if ($year_studying == "3") {
																		echo "selected";
																	} ?>>மூன்றாம் ஆண்டு (Third
																		Year)</option>
																	<option value="4" <?php if ($year_studying == "4") {
																		echo "selected";
																	} ?>>நான்காம் ஆண்டு (Fourth
																		year)</option>
																	<option value="5" <?php if ($year_studying == "5") {
																		echo "selected";
																	} ?>>ஐந்தாம் ஆண்டு (Fifth year)
																	</option>
																</select>
															</div>
															<div class="col-md-2" id="umis_cancel"
																style="display: none;">
														...
														<div class="row" id="have_umis_div" style="display:none">
															<div class="col-md-6">
																<label class="form-label" for="userName2">உங்களுடைய UMIS
																	எண்
																	கிடைத்ததா? / Have
																	you got yours UMIS Id? </label>
															</div>
															<div class="col-md-4">
																<select class="form-select" id="umisSelect"
																	onchange="get_values()">
																	<option selected value="">select</option>
												...
												<div class="" id="havingUmis" style="display: none;">
													<div class="row spel-app mt-2">
														<div class="col-md-6 normal-imput ">
															<div class="row">
																<div class="col-md-6">
																	<label class="form-label" for="userName2">தங்களின்
																		UMIS எண்ணினை பதிவிடவும் / Enter your UMIS ID
																		<br>
																...
																<div class="col-md-6">
																	<input type="text" id="umis_no" class="form-control"
																		oninput="number_only(this)"
																		onkeyup="empty_umis()" value="<?= $umis_no; ?>"
															...
															<div class="row">
																<div class="col-md-12">
																	<input type="button" data-bs-toggle="modal"
																		...
																		class="comm-btn mb-bt" onclick="umis_already()"
																		value="Go">
																</div>
															</div>
														</div>
													...
													<div class="row spel-app mt-3" id="toggleUmis"
														style="display: none;">
														<div class="col-md-6 normal-imput">
															<div class="row">
																<div class="col-md-6">
																	<label class="form-label"
																		for="userName2">மாணாக்கரின் முழுப் பெயர் /
																		Student Full Name ( As per UMIS )</label>
																</div>
																<div class="col-md-6">
																	<input type="text" id="umis_std_name" readonly
																		class="form-control" value="<?= $umis_name; ?>">
																</div>
																<div class="col-md-6">

																	<label class="form-label" for="userName2">பிறந்த
																		தேதி / Date of
																		Birth</label>
																</div>
																<div class="col-md-6">
																	<input type="text" id="umis_dob" readonly
																		class="form-control" value="<?= $umis_dob; ?>">
																</div>
																<div class="col-md-6">
																	<label class="form-label"
																		for="userName2">கல்லூரியில் சேர்க்கை பெற்ற ஆண்டு
																		/ Year of Admission in college</label>
																</div>
																<div class="col-md-6">
																	<input type="text" id="umis_yoa" readonly
																		class="form-control" value="<?= $umis_yoa; ?>">

																</div>
																<div class="col-md-6">
																	<label class="form-label" for="userName2">படிப்பு
																		ஆண்டு / Year
																		of
																		Study</label>
																</div>
																<div class="col-md-6">
																	<!-- <input type="text" id="umis_yos" class="form-control" value="<?= $umis_yos; ?>"> -->
																	<select class="form-select" id="umis_yos">
																		<option selected value="">Select</option>
																		<option value="1" <?php if ($umis_yos == "1") {
																			echo "selected";
																		} ?>>முதலாம் ஆண்டு (First
																			Year)</option>
																		<option value="2" <?php if ($umis_yos == "2") {
																			echo "selected";
																		} ?>>இரண்டாம் ஆண்டு (Second
																			Year)</option>
																		<option value="3" <?php if ($umis_yos == "3") {
																			echo "selected";
																		} ?>>மூன்றாம் ஆண்டு (Third
																			Year)</option>
																		<option value="4" <?php if ($umis_yos == "4") {
																			echo "selected";
																		} ?>>நான்காம் ஆண்டு (Fourth
																			year)</option>
																		<option value="5" <?php if ($umis_yos == "5") {
																			echo "selected";
																		} ?>>ஐந்தாம் ஆண்டு (Fifth
																			year)</option>
																	</select>
																	<span class="error-message text-danger"
																		id="error_umis_yos"></span>
																</div>
														...
														<div class="col-md-6 normal-imput">
															<div class="row ">
																...
																<div class="col-md-6">
																	<input type="text" id="umis_std_degree"
																...
																<div class="col-md-6">
																	<input type="text" id="umis_std_course" readonly
																		class="form-control"
																		value="<?= $umis_std_course; ?>">
																</div>

																<div class="col-md-6">
																	<label class="form-label" for="userName2">கல்லூரி
																		பெயர் /
																		College
																		Name</label>
																</div>
																<div class="col-md-6">
																	<input type="text" id="umis_clg_name"
																		class="form-control"
																		value="<?= $umis_clg_name; ?>" readonly>
																</div>
																<div class="col-md-6">
																...
																<div class="col-md-6">
																	<input type="text" id="umis_clg_add"
																		class="form-control"
																		value="<?= $umis_clg_add; ?>" readonly>
																</div>
														...
														<div class="form-check form-check-inline">
															<label class="form-check-label" for="customCheck3">I confirm
																...
																are mine and correct</label>
															<input type="checkbox" class="form-check-input"
																id="umis_check" name="umis_check"
																onclick="get_umis_check()" value="YES">
														</div><br>
												...
												<div class="row spel-app mt-2" id="Noumis" style="display: none;">
													<div class="col-md-6 normal-imput">
														<div class="row">
															...
															<div class="col-md-6">
																<input type="text" id="no_umis_name"
																	class="form-control" value="<?= $no_umis_name ?>"
																	oninput="valid_user_name(this)">
																<span class="error-message text-danger"
																	id="error_no_umis_name"></span>
															</div>
															<div class="col-md-6">
																<label class="form-label" for="userName2">கல்லூரியில்
																	சேர்க்கை பெற்ற ஆண்டு / Year of Admission in
																	college</label>
															</div>
															<div class="col-md-6">
														...
														value="<?= $no_umis_stream; ?>"> -->
															...
															<div class="col-md-6">
																<select class="form-select mb-0" id="no_umis_course" onchange="get_course_branch()">
													...
													<label class="form-label" for="userName2">பாடப்பிரிவு /
														Course Branch</label>
												</div>
												<div class="col-md-6">
													<select class="form-select mb-0" id="no_umis_branch">
														<?php echo $course_branch_options; ?>
													</select>
													<span class="error-message text-danger"
														id="error_no_umis_branch"></span>
														...
														<div class="col-md-6">
															...
															<div class="col-md-6">
																<select class="form-select mb-0 "
																	id="no_umis_clg_district"
																	onchange="host_district(); get_institute_name();">
														...
														<?php echo $institute_id_options; ?>

													</select>

																<!-- <input type="text" name="no_umis_college"
																	id="no_umis_college" class="form-control"
															...
															<div class="col-md-6">
																<label class="form-label" for="userName2">அஞ்சல்
																	குறியீடு / Pincode
																</label>
															</div>
															<div class="col-md-6">

																<input type="text" name="no_umis_pincode"
																	id="no_umis_pincode" class="form-control"
																	onkeyup="validateNumber()" maxlength="6"
																	oninput="pincode(this)"
																	value="<?= $no_umis_pincode; ?>">
													...
													<div class="form-check form-check-inline">
														<label class="form-check-label" for="customCheck3">I confirm
															...
															are mine and correct</label>
														<input type="checkbox" class="form-check-input"
															id="no_umis_check" name="no_umis_check"
															onclick="get_no_umis_check()" value="YES">
													</div><br><br>
									...
									>
										...
										<div class="clearfix"></div> -->
												...
												<div class="buttn">
													...
													<div class="float-end mt-3">
														<input type="button" class="btn btn-info" name="next"
															value="Save & Continue" onclick="umis_details_add()"
															id="umis_btn" disabled>
								...
								<div class="tab-pane" id="tab33" role="tabpanel">
									<?php if ($student_status == 0) { ?>
										<div class="row spel-app  ">
											...
											<div class="col-md-7">
												<div class="row normal-imput">
													<div class="col-md-7">
														<label class="form-label" for="userName2">நீங்கள் எந்த வகுப்பைச்
															சார்ந்தவர்? / Which Community category do you belongs to
															?</label>
													</div>
													<div class="col-md-5">

														<select class="form-select" id="com_name"
															onchange="get_cert_detail()">
										...
										<div class="row" id="communityno_div" style="display:none">
											<div class="col-md-8">
												<div class="row normal-imput">
													...
													<div class="col-md-6">
														<label class="form-label" for="userName2">சாதிச் சாண்றிதழ் எண் /
															Community Certificate No.</label>
													</div>
													<div class="col-md-6">
														<input type="text" id="communityno" name="communityno"
															class="form-control" onkeyup="empty_com()" value="<?= $c_no; ?>"
															maxlength="17" oninput="validateCharInput(this)">
													</div>
												</div>
											</div>
											...
											<div class="row spel-app ">
													...
													<div class="row normal-imput">
														...
														<div class="col-md-6 ">
															<input type="text" id="fullname1" name="fullname1"
																class="form-control" value="<?= $c_name; ?>"
																oninput="valid_user_name(this)">
														</div>
														<div class="col-md-6 ">


															<label class="form-label" for="userName2">வகுப்பு / Communal
																Category</label>
														</div>
														<div class="col-md-6 ">
															<input type="text" id="castename" name="castename"
																class="form-control" value="<?= $caste_name; ?>"
																oninput="valid_user_name(this)">
														</div>
														<div class="col-md-6 ">


															<label class="form-label" for="userName2">சாதி உட்பிரிவின்
																பெயர் / Name of the Sub-caste</label>
														</div>
														<div class="col-md-6 ">
												...
												<div class="col-md-6 ">
													<div class="row normal-imput">
														...
														<div class="col-md-6 ">
															<label class="form-label" for="userName2">தந்தையின் பெயர் /
																Father
																Name</label>
														</div>
														<div class="col-md-6 ">
														...
														<div class="col-md-6 " id="com_file_div">
															<input type="hidden" id="community_pdf" name="community_pdf"
																...
																value="<?php echo $community_pdf; ?>">
															<a id="download_link" href="<?php echo $community_pdf; ?>"
																class=""><img src="pdf.png" height="45px" width="45px"></a>
									...
									<?php } else { ?>
										...
										<div class="row spel-app mt-3" id="togglecom">
											...
											<div class="col-md-7">
												<div class="row normal-imput">
													<div class="col-md-6">
														...
														<label class="form-label" for="userName2">வருமானம் சான்றிதழ் எண்
															/ Income
															Certificate No</label>
													</div>
													<div class="col-md-6">

														<input type="text" id="incomecerno" name="incomecerno"
															class="form-control" onkeyup="empty_inc()" value="<?= $i_no; ?>"
															oninput="validateCharInput(this)" maxlength="17">
											...
											<div class="row spel-app ">
													...
													<div class="row normal-imput">
														...
														<div class="col-md-6 ">
															<input type="text" id="fullname4" name="fullname4"
																...
																readonly value="<?= $i_name; ?>">
														</div>
														<div class="col-md-6 ">

															<label class="form-label" for="userName2">வருமான நிலை /
																Income
																Level</label>
														</div>
														<div class="col-md-6 ">
														...
														<div class="col-md-6 ">
															<input type="text" id="fathername4" name="fathername4"
																class="form-control" oninput="valid_user_name(this)"
																disabled value="<?= $i_father_name; ?>"
																onkeypress="input_status()">
														</div>
														<div class="col-md-6 ">

															<label class="form-label" for="userName2">தாய் பெயர் /
																Mother Name
															</label>
														</div>
														<div class="col-md-6 ">
															<input type="text" id="mothername4" name="mothername4"
																class="form-control" disabled value="<?= $i_mother_name; ?>"
																oninput="valid_user_name(this)" onkeypress="input_status()">
															<input type="hidden" id="input_status" name="input_status"
																class="form-control" value="<?= $input_status; ?>">
												...
												<div class="col-md-6 ">
													<div class="row normal-imput">
														...
														<div class="col-md-6 ">
															<input type="text" id="fatherincomesource"
																name="fatherincomesource" readonly class="form-control"
																value="<?= $f_income_source; ?>">
														</div>
														...
														<div class="col-md-6 ">
															<input type="text" id="motherincomesource"
																name="motherincomesource" class="form-control"
																value="<?= $m_income_source; ?>">
														</div>
														...
														<div class="col-md-6 ">
															<input type="hidden" id="income_pdf" name="income_pdf"
																class="form-control mt-2"
																value="<?php echo $income_pdf; ?>">
															<a id="download_link_income" href="<?php echo $income_pdf; ?>"
																class=""><img src="pdf.png" height="45px" width="45px"></a>
														</div>
									...
									<?php } else { ?>
										...
										<div class="row spel-app mt-3" id="toggleinc">
											<div class="row spel-app ">
												<div class="col-md-6 ">
													<div class="row normal-imput">
														...
														<div class="col-md-6 ">
															<input type="text" id="fathername4" name="fathername4"
																class="form-control" oninput="valid_user_name(this)"
																value="<?= $i_father_name; ?>" onkeypress="input_status()">
														</div>
														<div class="col-md-6 ">
														...
														<div class="col-md-6 ">
															<input type="text" id="mothername4" name="mothername4"
																class="form-control" value="<?= $i_mother_name; ?>"
																oninput="valid_user_name(this)" onkeypress="input_status()">
															<input type="hidden" id="input_status" name="input_status"
																class="form-control" value="<?= $input_status; ?>">
												...
												<div class="col-md-6 ">
													<div class="row normal-imput">
														...
														<div class="col-md-6 ">
															<input type="text" id="fatherincomesource"
																name="fatherincomesource" class="form-control"
																value="<?= $f_income_source; ?>">
														</div>
									...
									<div class="row spel-app ">
										...
										<div class="col-md-8 mb-4">
											<div class="row normal-imput">
												<div class="col-md-8 ">
													<label class="form-label" for="userName2">நீங்கள் மாற்றுத்
														திறனாளியா? / Are
												...
												<div class="col-md-4 ">
													...
													<input type="text" id="diff_abled" name="diff_abled"
														class="form-control" value="<?= $diffabled; ?>"
														style="display:none">
												</div>
											</div>
										</div>
										...
										<div id="phy_div" class="row" style="display:none">
											<div class="col-md-6 ">
												<div class="row normal-imput">
													...
													<div class="col-md-6 ">
														<label class="form-label" for="userName2">வகை /
															Category</label>
													</div>
													<div class="col-md-6 ">
													...
													<div class="col-md-6 ">
														<label class="form-label" for="userName2"> அடையாள எண் / ID
															Number
														</label>
													</div>
													<div class="col-md-6 ">
											...
											<div class="col-md-6 ">
												<div class="row normal-imput">
													...
													<div class="col-md-6 ">
														<input type="text" id="disabilitypercentage"
															name="disabilitypercentage" class="form-control"
													...
													<div class="col-md-6 ">
														<input type="file" id="disabilitycertificate"
															name="disabilitycertificate" class="form-control mt-2"
										...
										<div class="form-check form-check-inline">
											<label class="form-check-label" for="customCheck3">I confirm that the
												above details
												are mine and correct</label>
											<input type="checkbox" class="form-check-input" id="cert_check"
												name="cert_check" onclick="get_certificate_check()" value="YES">
										</div><br><br>
									</div>
									<div>
										<div class="float-end mt-3">
											<input type="button" class="btn btn-info" name="next"
												value="Save & Continue" onclick="certificateinfo()" id="cert_btn"
												disabled>
								...
								<div class="tab-pane" id="tab34" role="tabpanel">
											...
											<div class="row">
												...
												<div class="col-md-6">
													<input type="text" id="bloodgroup" name="bloodgroup"
														class="form-control" value="<?= $blood_group; ?>"
														style="display:none">
													...
													<span class="error-message text-danger"
														id="error_bloodgroup"></span>


												</div>

												<div class="col-md-6">
													<label class="form-label" for="userName2"> மின்னஞ்சல் முகவரி / Email
														Id
													</label>
												</div>
												<div class="col-md-6">
									...
									<div class="col-md-6">
											...
											value="<?= $contact_no; ?>" oninput="number_only(this)" maxlength="10">
												...
												<div class="col-md-6">
													...
													<select class="form-select mb-0 " id="refugee" name="refugee">
														<option selected value="">Select</option>
														<option value="YES" <?php if ($refugee == "YES" || $student_status == 1) {
															echo "selected";
														} ?>>Yes
														</option>
														<option value="NO" <?php if ($refugee == "NO" || $student_status != 1) {
															echo "selected";
														} ?>>No
														</option>
												...
												<div class="col-md-6" id="orphan_label">
													<label class="form-label" for="userName2">ஆதரவற்ற குழந்தை /
														Orphan</label>
												</div>
												...
												<div class="col-md-6">
													<label class="form-label" for="userName2">ஒற்றை பெற்றோர் குழந்தை /
														Single
														Parent Child</label>
												</div>
												<div class="col-md-6">

													<select class="form-select mb-0" id="singleparent"
														name="singleparent">
														<option selected value="">Select</option>
												...
												<div class="col-md-6" id="fg_div">
													...
													<input type="text" id="firstgraduate" name="firstgraduate"
														class="form-control" value="<?= $first_graduate ?>"
														style="display:none" oninput="validateCharInput(this)">
													<span class="error-message text-danger"
														id="error_firstgraduate"></span>
										...
										<div class="col-md-6">
											<div class="row normal-imput">
												...
												<div class="col-md-6">
													...
													<label class="form-label" for="userName2">தந்தையின் கல்வி தகுதி /
														Father Educational Qualification</label>
												</div>
												<div class="col-md-6">
													...
													<span class="error-message text-danger"
														id="error_dadqualification"></span>


												</div>
												<div class="col-md-6">
													<label class="form-label" for="userName2">தாயின் கல்வி தகுதி /
														Mother Education Qualification</label>
												</div>
												<div class="col-md-6">
													<input type="text" id="momqualification" name="momqualification"
														...
														oninput="valid_address(this)">
													<span class="error-message text-danger"
														id="error_momqualification"></span>
												...
												<div class="col-md-6">
													<input type="text" id="dadOccupation" name="dadOccupation"
														class="form-control" value="<?= $father_occu; ?>"
														oninput="valid_user_name(this)">
													<span class="error-message text-danger"
														id="error_dadOccupation"></span>
												...
												<div class="col-md-6">
													<input type="text" id="momOccupation" name="momOccupation"
														class="form-control" value="<?= $mother_occu; ?>"
														oninput="valid_user_name(this)">
													<span class="error-message text-danger"
														id="error_momOccupation"></span>
												...
												<div class="col-md-6">
													<input type="text" id="dadmobno" name="dadmobno"
														class="form-control" value="<?= $father_no; ?>"
														oninput="valid_mobile_number(this)" maxlength="10">
													<span class="error-message text-danger" id="error_dadmobno"></span>

												</div>
												<div class="col-md-6">

													<label class="form-label" for="userName2">பெற்றோர்/ பாதுகாவலர்
														கைப்பேசி எண் / Parent/Guardian Mobile No</label>
												</div>
												<div class="col-md-6">
													<input type="text" id="guardianno" name="guardianno"
														class="form-control" value="<?= $guardian_no; ?>"
														oninput="valid_mobile_number(this)" maxlength="10">
													<span class="error-message text-danger"
														id="error_guardianno"></span>
												...
												<div class="col-md-6">
													<label class="form-label" for="userName2">தற்போதைய முகவரி / Present
														Address</label>
												</div>
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<label class="form-label" for="userName2">கதவு எண் / Door
														No.</label>
												</div>
												...
												<div class="col-md-6">
													<input type="text" id="street_name" name="street_name"
														class="form-control" value="<?= $street_name; ?>"
														oninput="valid_address(this)">
													<span class="error-message text-danger"
														id="error_street_name"></span>

												</div>

												<div class="col-md-6">
													<label class="form-label" for="userName2">பகுதியின் பெயர் / Area
														Name</label>
												</div>
												<div class="col-md-6">
													<input type="text" id="area_name" name="area_name"
														class="form-control" value="<?= $area_name; ?>"
														oninput="description_val(this)">
												...
												<div class="col-md-6">
													<label class="form-label" for="userName2">மாவட்டம் / District
													</label>
												</div>
												<div class="col-md-6">
												...
												<div class="col-md-6">
													<input type="text" id="Pincode" name="Pincode" class="form-control"
														maxlength="6" onkeyup="validatepincode()"
														oninput="pincode(this)" value="<?= $pincode; ?>">
										...
										<!-- <div class="row"> -->
										<div class="form-check form-check-inline">
											<label class="form-check-label" for="customCheck3">I certify that all the
												above details
												are correct</label>
											<input type="checkbox" class="form-check-input" id="fam_check"
												name="fam_check" onclick="get_familyinfo_check()" value="YES">
										</div><br>
									</div>
									<div>
										<div class="float-end mt-3">
											<input type="button" class="btn btn-info" name="next"
												value="Save & Continue" onclick="familyinfo()" id="fam_btn" disabled>

										</div>
										<div class="float-start mt-3">

											<button type="button" class="btn btn-info" name="previous"
												onclick="back(this.value)" value="4">Previous</button>
										</div>
									</div>
									...
									<select class="form-select" id="priority">
											<?php echo $priority_type_options; ?>
												...
												<div class="col-md-6 ">
													...
													<?php if ($student_status == 1) { ?>
														<h5 id="gender_name"><?php  if($gender){echo gender_type($gender)[0]['gender_type'];}else{echo '';} ?></h5>
													<?php } else { ?>
														<h5 id="gender_name"><?= $agender; ?></h5>
													<?php } ?>
												</div>
												...
												<div class="col-md-6 ">
													<label class="form-label" for="userName2" id="scl_dis"
														style="display:none">உன்
														பள்ளி மாவட்டம் / Your School
														District</label>
													<label class="form-label" for="userName2" id="clg_dis">உங்கள்
														கல்லூரி மாவட்டம் /
														Your College
														District</label>
												</div>
												<div class="col-md-6 ">
													...
													<input type="hidden" id="hostel_district" style="display:none"
														readonly>
													<input type="hidden" id="emis_hostel_district" style="display:none"
														readonly>
														...
														<div class="box-contents">
															<div id="audit-trail">
																<ul>
																	...
																	<li>
																		<p style="margin-bottom: 6px;padding: 5px 0px;">
																			Kindly note
																			that you can only add up to three priorities
																		</p>
																	</li>
																</ul>
															</div>
	...
	<script src="folders/application_form/application.js"></script>
