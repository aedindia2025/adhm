...
var options = {
    series: [{
        ...
        data: [1202,100,4262,133,152,4332,2353,1223,3213,4321,1234,4321,2324,3242,1202,100,
            4262,133,152,4332,2353,1223,3213,4321,1234,4321,2324,3242,4332,2353,1223,3213,
            4321,1234,4321,2324,3242,2353
        ]
    },
    {
        name: 'Renewal Application',
        data: [-1223,-3213,-4321,-1234,-4321,-2324,-3242,-4332,-2353,-1223,-3213,
            -4321,-1234,-4321,-0,-3242,-2353,-1202,-100,-4262,-133,-152,-4332,-2353,-1223,-3213,-4321,-1234,-4321,-2324,-3242,-1202,-100,
            -4262,-133,-152,-4332,-2353
        ]
    }
    ],
    chart: {
    ...
    xaxis: {
        categories: ['Ariyalur', 'Chengalpattu', 'Chennai', 'Coimbatore', 'Cuddalore', 'Dharmapuri', 'Dindigul', 'Erode', 'Kallakurichi',
            'Kanchipuram', 'Kanyakumari', 'Karur', 'Krishnagiri', 'Madurai', 'Mayiladuthurai', 'Nagapattinam', 'Namakkal', 'Nilgiris',
            'Perambalur', 'Pudukkottai', 'Ramanathapuram', 'Ranipettai', 'Salem', 'Sivagangai', 'Tenkasi', 'Thanjavur', 'Theni', 'Thiruchirapalli',
            'Thiruvallur', 'Thiruvannamalai', 'Thiruvarur', 'Tirunelveli', 'Tirupattur', 'Tiruppur', 'Tuticorin', 'Vellore', 'Villupuram', 'Virudhunagar'
        ],
        // title: {
        //     text: 'Percent'
        // },
