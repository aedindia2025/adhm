...
function stock_id()
{
    ...
    $servername = "10.236.205.74";
    $username = "root";
    $password = "zu3jtxdAfFbUxThS";
    ...
    $stmt = $conn->query("SELECT * FROM stock_consumble_entry where stock_id LIKE 'STK%' order by id desc");
                    ...
                    <div class="row">
                        ...
                        <div class="">
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <div class="col-md-3 fm">
                                            ...
                                            <label for="simpleinput" class="form-label">Stock Outward Entry No</label>
                                        </div>
                                        <div class="col-3 fm">
                                    ...
                                    <select name="cars" id="cars" class="form-control">
                                        ...
                                        <div class="col-3">
                                            ...
                                            <input type="hidden" id="main_unique_id" name="main_unique_id" class="form-control" placeholder=" " value='<?php echo $unique_ids; ?>'>
                                        </div> -->
                                        <div class="col-md-3 fm">
                                                    ...
                                                    <form class="was-validated" autocomplete="off">
                                                        ...
                                                        <table id="document_upload_sub_datatable"
                                                            ...
                                                            <thead class="table-light">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td><select class="form-control" name="item_name"
                                                                            id="item_name"
                                                                            onchange="get_unit_name(this.value)"><?php echo $product_type_option;  ?>
                                                                    </td>
                                                                    <td><input type="text" class="form-control"
                                                                            name="qty" id="qty" onkeyup="get_total()">
                                                                    </td>
                                                                    <td><select name="unit" id="unit"
                                                                            class="form-control"><?php echo $unit_options; ?></select>
                                                                    </td>
                                                                    <td><input type="text" class="form-control"
                                                                            name="rate" id="rate" onkeyup="get_total()">
                                                                    </td>
                                                                    <td><input type="text" class="form-control"
                                                                        ...
                                                                        <input type="hidden" id="stock_id"
                                                                            name="stock_id" class="form-control"
                                                                            value='<?php if ($stock_ids == '') {
                                                                                                                                                            echo stock_id();
                                                                                                                                                        } else {
                                                                                                                                                            echo $stock_ids;
                                                            ...
                                                            <tr>
                                                                <td></td>
                                                                <td></td>
                                                                <td id="totalqty">Total Qty :
                                                                    <br><?php echo $tot_qty; ?>
                                                                </td>
                                                                <td></td>
                                                                <td></td>
                                                                <td id="totalamount">Total Amount :
                                                                    <br><?php echo $tot_amount; ?>
                                                                </td>
                                                ...
                                                <div class="row" style="margin-left: 54%;">
                                                    ...
                                                    <div class="col-2">
                                                        <input type="text" name="gst" id="gst"
                                                            value='<?php echo $gst; ?>' onmouseout="getgstamount()">
                                                    </div>
                                                    ...
                                                    <div class="col-6">
                                                        <p id="net_amt">
                                                            <?php if($net_total_amount){ echo $net_total_amount;}else{ echo  $tot_amount;} ?>
                                                        </p>
                                                        <input type="hidden" name="net_total_amount"
                                                            id="net_total_amount"
                                                            value='<?php if($net_total_amount){ echo $net_total_amount;}else{ echo  $tot_amount;} ?>'>
                                                    </div>
                                ...
                                <div class="btns">
                                    <a href="index.php?file=stock_consumble_entry/list"><button type="button"
                                            class="btn btn-danger  m-t-15 btn-rounded waves-effect waves-light float-right ml-2">Cancel</button></a>
                                    <?php if ($unique_ids == '') {?>
        ...
        for (var i = 0; i < image_s.length; i++) {
            if (!allowedExtensions.test(files[i].name)) {
                ...
                errorMessageSpan.textContent =
                    "Error: Only PDF, images (JPG, JPEG, PNG, GIF), and Excel files (XLSX, XLS) are allowed.";
            } else {
