                ...
                <div class="col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mb-3">
                                        ...
                                        <label for="simpleinput" class="form-label">Student ID</label>
                                            ...
                                            <select class="form-control" id="std_reg_no" name="std_reg_no" value="" onchange="get_std_name()" required>
                            ...
                            <input type="text" class="form-control" name="job" id="job" oninput="description_val(this)" value="<?php echo $job;?>">
                             </div>
                             
                             <div id="course_div"  class="col-md-3 mt-2 fm"style="display:none;">
                            <label for="textBox" class="form-label">Course</label>
                            <input type="text" class="form-control" name="course" id="course" oninput="description_val(this)" value="<?php echo $course;?>">
                             </div>
<!-- </div> -->
