                    ...
                    <div class="card mb-0">
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 c-v">
                                    <h5 class="mt-0 mb-1">Application Processed</h5>
                ...
                <div class="col-sm-4">
                    <div class="card tilebox-one bb-1">
                        ...
                        <a href="javascript:void(0)" 
                            onclick="new_external_window_print_new(event,'folders/dashboard/total_students.php');"
            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="card tilebox-one bb-2">
                        ...
                        <a href="javascript:void(0)" 
                        onclick="new_external_window_print_new(event,'folders/dashboard/dadwo_approved.php');"
                        class="view">Read More</a>
                    </div>
                </div>
                ...
                <div class="col-sm-4">
                    <div class="card tilebox-one bb-1">
                        ...
                        <a href="javascript:void(0)"
                        onclick="new_external_window_print_new(event,'folders/dashboard/pushed_students.php');"
                        class="view">Read More</a>
                    </div>
                </div>
            </div>
