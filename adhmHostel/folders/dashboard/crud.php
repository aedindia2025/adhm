...
switch ($action) {
    ...
    case 'get_accept_count':
        ...
        $where = "is_delete = 0 AND hostel_name = '" . $hostel_id . "'";
    ...
    case 'get_approved_count':
        ...
        $where = "is_delete = 0 AND dropout_status = '1' AND hostel_1 = '" . $hostel_id . "'";
    ...
    case 'get_rejected_count':
        ...
        $where = "is_delete = 0 AND status = '2' AND hostel_name = '" . $hostel_id . "'";
    ...
    case 'get_dropout_count':
        ...
        $where = "is_delete = 0 AND dropout_status = '2' AND hostel_1 = '" . $hostel_id . "'"; // 2 = dropout
    ...
    case 'get_hostel_by_taluk_name':
        ...
        $hostel_id_options = hostel_name('', $taluk_name);

        $hostel_id_options = select_option($hostel_id_options, "Select Hostel");

        echo $hostel_id_options;
    ...
    case 'get_vacancy_count':
        ...
        $json_array = "";
        $columns = [
            "(select sum(sanctioned_strength) as str_cnt from hostel_name where hostel_1 = '" . $_SESSION['hostel_id'] . "') as tot_cap",
            "'' as old_std",
        ...
        $where = "hostel_1 = '" . $_SESSION["hostel_id"] . "' and status = '1'";
        $result = $pdo->select($table_details, $where);
        $res_array = $result->data;
        //    print_r($result);die();
        foreach ($res_array as $value) {
    ...
    case 'get_total_staffs':
        ...
        if ($hostel_id != '') {
            $where .= " AND er.hostel_name = '" . $hostel_id . "'";
        }
    ...
    case 'total_students':
        ...
        if ($hostel_id != '') {
            $where .= " AND a.hostel_1 = '" . $hostel_id . "'";
        }
    ...
    case 'total_staff_strength':
        ...
        if ($hostel_id != '') {
            $where .= " AND a.hostel_name = '" . $hostel_id . "'";
        }
    ...
    case 'hostel_vaccancy':
        ...
        foreach ($res_array as $value) {
            ...
            $registered_cnt = total_reg_count('', $district_name, $taluk_name, $hostel_id, $gender_type, $hostel_type);
    ...
    case 'get_face_and_finger':
        ...
        $json_array = "";
        $columns = [
            "(SELECT count(unique_id) FROM std_reg_s WHERE is_delete = 0 AND dropout_status = 1 AND face_id_status = 1 AND hostel_1 = '" . $hostel_id . "') as face_reg",
            "(SELECT count(unique_id) FROM std_reg_s WHERE is_delete = 0 AND dropout_status = 1 AND face_id_status != 1 AND hostel_1 = '" . $hostel_id . "') as face_not_reg",
            "(SELECT count(unique_id) FROM std_reg_s WHERE is_delete = 0 AND dropout_status = 1 AND fingerprint_status = 1 AND hostel_1 = '" . $hostel_id . "') as finger_reg",
            "(SELECT count(unique_id) FROM std_reg_s WHERE is_delete = 0 AND dropout_status = 1 AND fingerprint_status != 1 AND hostel_1 = '" . $hostel_id . "') as finger_not_reg"
        ];
        $table_details = [
            "std_reg_s",
            $columns
    ...
    case 'get_biometric_details':
        ...
        $json_array = "";
        $columns = [
            "(SELECT count(unique_id) FROM std_reg_s WHERE is_delete = 0 AND dropout_status = 1 AND bio_reg_status = 1 AND hostel_1 = '" . $hostel_id . "') as std_pushed",
            "(SELECT count(unique_id) FROM std_reg_s WHERE is_delete = 0 AND dropout_status = 1 AND hostel_1 = '" . $hostel_id . "') as students_approved"
        ];
        $table_details = [
            "std_reg_s",
            $columns
...
function total_reg_count($unique_id = "", $district_name = "", $taluk_name = "", $hostel_id = "", $gender_type = [], $hostel_type = [])
{
    global $pdo;
