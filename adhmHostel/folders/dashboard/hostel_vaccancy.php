                                    ...
                                    <table cellspacing="0" cellpadding="0" class="" width="100%" style="font-family: monospace;">
                                        <thead class="colspanHead">
                                            <tr>
                                                ...
                                                <th width="10%" colspan="1" class="blankCell">Sanctioned Strength</th>
                                                <th width="10%" colspan="1" class="blankCell">Registered Strength</th>
                                                <th width="10%" colspan="1" class="blankCell">Hostel Vaccancy</th>
                                            </tr>
                                        </thead>
                                        <?php
                                        $start = 0;
                                        ...
                                        $where_list = "is_delete = 0 and sanctioned_strength !='' AND hostel_1 = '" . $hostel_id . "'";
                                        ...
                                        if ($result->status) {
                                            ...
                                            if (count($res_array) == 0) {
                                                ...
                                                foreach ($res_array as $key => $value) {
                                                    ...
                                                    $registered_cnt = total_reg_count($unique_id);

                                                    $sanctioned_cnt = $value['sanctioned_strength'];

                                                    // $registered_cnt = total_reg_count();
                                                    // print_r($registered_cnt);die();
                                                    ...
                                                    $table_data .= "<td style = 'text-align : left'>" . $value['sanctioned_strength'] . "</td>";
                                                    $table_data .= "<td style = 'text-align : left'>" . $registered_cnt . "</td>";
                                                    $table_data .= "<td style = 'text-align : left'>" .$hostel_vaccancy . "</td>";
