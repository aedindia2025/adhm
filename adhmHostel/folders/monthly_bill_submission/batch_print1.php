    ...
    if ($_GET["unique_id"]) {
        ...
        $columns = [
            ...
            "std_app_no",
            "entry_date",
            "(select academic_year from std_app_s where std_app_s.std_app_no = $table.std_app_no) as academic_year",
            "address",
            "unique_id"
        ...
        if ($result_values_s6->status) {
            ...
            $std_father_name        = $result_values_s6[0]["std_father_name"];
            $std_mother_name        = $result_values_s6[0]["std_mother_name"];
            $std_mother_qual        = $result_values_s6[0]["std_mother_qual"];
            $std_father_qual        = $result_values_s6[0]["std_father_qual"];
            $std_father_occu        = $result_values_s6[0]["std_father_occu"];
            $std_mother_occu        = $result_values_s6[0]["std_mother_occu"];
            $std_single_parent      = $result_values_s6[0]["std_single_parent"];

            
            $student_dob_s6           = $result_values_s6[0]["dob"];

            $student_age           = $result_values_s6[0]["age"];

        // $diffabled             = $result_values_s6[0]["diffabled"];
            $student_blood_group   = $result_values_s6[0]["blood_group"];
            $std_email_id          = $result_values_s6[0]["email_id"];
            $std_religion          = $result_values_s6[0]["religion"];
            $std_mother_tongue     = $result_values_s6[0]["mother_tongue"];
            $std_refugee           = $result_values_s6[0]["refugee"];
            $std_orphan            = $result_values_s6[0]["orphan"];
            $std_first_graduate    = $result_values_s6[0]["first_graduate"];
            $std_father_num        = $result_values_s6[0]["father_no"];
        ...
        $table1 = "batch_creation";

        $columns1 = [

            "(select priority from std_app_s7 where hostel_name = $table1.hostel_name)as hostel_priority",
            "applied_date",
            "hostel_name as std_hostel_name",
            "hostel_district as std_hostel_district",
            "hostel_taluk as std_hostel_taluk"
        ...
        if ($result_values1->status) {
            ...
            $hostel_priority = $result_values1[0]["hostel_priority"];

            $std_hostel_name        = hostel_name($result_values1[0]["std_hostel_name"])[0]['hostel_name'];
            $std_hostel_district    = district_name($result_values1[0]["std_hostel_district"])[0]['district_name'];
            $std_hostel_taluk       = taluk_name($result_values1[0]["std_hostel_taluk"])[0]['taluk_name'];
    ...
    $columns3    = [
        ...
        "(select emis_no from std_app_emis_s3 where std_app_emis_s3.s1_unique_id = $table3.unique_id)as student_emis_no",
        "application_type",
    ...
    $columns    = [
        ...
        "umis_std_degree",
        "umis_std_course",
        "umis_yos as std_clg_yr",
        "umis_clg_add as std_clg_addr",
        "umis_no as std_clg_umis_no",
        "(select college_name from college_creation where college_creation.unique_id= $table6.no_umis_college) as no_umis_college",
        "no_umis_name",
    ...
    if ($result_values6->status) {
        ...
        $student_studying_year      = $result_values6[0]["std_clg_yr"];
        $student_clg_address      = $result_values6[0]["std_clg_addr"];
        $clg_umis_no      = $result_values6[0]["std_clg_umis_no"];
        ...
        <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <p class="font-12">DOB: <strong><?= $student_dob_s6; ?></strong></p>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <p class="font-12">Age: <strong><?php echo $student_age; ?></strong></p>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <p class="font-12">Father Name: <strong><?php echo $std_father_name; ?></strong></p>
                                </div>
                                <div class="col-sm-6">
            ...
            <div class="col-sm-12 ">
                <div class="mt-0 float-sm-left">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <p class="font-12"> Age: <strong><?= $student_age; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Blood Group: <strong><?= $student_blood_group; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Gender : <strong><?= $std_gender; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12"> Email Id : <strong><?= $std_email_id; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Religion : <strong><?= $std_religion; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Mother Tongue : <strong><?= $std_mother_tongue; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <?php if ($std_orphan == 'NO') { ?>
                            <div class="col-sm-4">
                                <p class="font-12">Father Name: <strong><?= $std_father_name; ?></strong></p>
                            </div>
                            <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <p class="font-12"> Parent Number : <strong><?= $std_father_num; ?></strong></p>
                        </div>
                        ...
                        <?php } ?>
                        <div class="col-sm-4">
                            <p class="font-12"> Srilankan Refugees: <strong><?= $std_refugee; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                            <p class="font-12">Orphanages: <strong><?= $std_orphan; ?></strong></p>
                        </div>
                        <div class="col-sm-4">
                        ...
                        <?php } ?>
                        <div class="col-sm-4">
                            <p class="font-12">First Graduate: <strong><?= $std_first_graduate; ?></strong></p>
                        </div>
                ...
                <div class="mt-0 float-sm-left">
                    <div class="row">
                        <?php if ($student_type == "65f00a259436412348") { ?>
                            ...
                            <div class="col-sm-4">
                        <p class="font-12">EMIS NO: <strong><?php echo $student_emis_num; ?></strong></p>
                    </div>
                    </div>
                <?php } else { ?>
            ...
            <?php } else { ?>
               ...
               <div class="col-sm-4">
                    ...
                    <div class="col-sm-4">
                        <p class="font-12">Studying year: <strong><?php echo $no_umis_yos;?></strong></p>
                    </div>
    ...
    <div class="col-sm-12 mb-2 ">
        <div class="mt-0 float-sm-left">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    <p class="font-12">Full Name : <strong><?= $stduent_name; ?></strong></p>
                </div>
                <div class="col-sm-4">
                ...
                <div class="col-sm-4">
                 ...
                 <div class="col-sm-4">
                    ...
                    <?php } else { ?>
                        ...
                        <p class="font-12"> Community Certificate: <strong><a href="<?= $income_pdf; ?>"><img src="../../uploads/pdf.png" width="20%" height="36%"></a></strong></p>
            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-4">
                 ...
                 <div class="col-sm-4">
                    <p class="font-12"> Income Certificate: <strong><a href="<?= $income_pdf; ?>"><img src="../../uploads/pdf.png" width="20%" height="36%"></a></strong></p>
                </div>
