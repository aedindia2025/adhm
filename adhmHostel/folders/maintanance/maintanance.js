...
function maintanance_cu(unique_id = "") {
    ...
    var main_doc = $("#main_doc").val();
    // var main_doc     = parseInt($("#main_doc").val());
    var unique_id = $("#unique_id").val();


    // var is_form      = form_validity_check("was-validated");
    var image = $("#test_file").val();
...
if(file){
    ...
    if ((image != '' || main_doc != '') && asset_category != '' && asset_name != '' && spend_amount != '' && description != '') {
...
function print_view(file_name) {
    var iframeContent = '<html><head><style>body, html {width: 100%; height: 100%; margin: 0; padding: 0;}</style></head><body>' +
        '<iframe id="myIframe" src="uploads/maintanance' + file_name + '"' + ' style="height:100%; width:100%; border:none;"></iframe>' +
        '</body></html>';
...
function print_pdf(file_name) {
    var pdfUrl = "uploads/maintanance/" + file_name;
...
function print(file_name) {
    ...
    var excelUrl = "uploads/maintanance/" + file_name;
    var link = document.createElement("a");
    link.href = excelUrl;
    link.download = file_name;
    document.body.appendChild(link);
