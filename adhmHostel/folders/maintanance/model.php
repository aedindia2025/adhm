...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $maintanence_no      = $result_values[0]["maintanance_no"];
            $main_doc      = $result_values[0]["file_name"];
...
<div class="row mb-3"> -->
                                        <div class="col-md-3 fm">
                                            ...
                                            <textarea name="description" id="description" class="form-control" rows="2" col="20" oninput="description_val(this)" required><?= $description; ?></textarea>
                                        </div>

                                        <div class="col-md-3 fm">
                                            <label for="example-select" class="form-label">Spend Amount</label>
                                            <input type="text" class="form-control" id="spend_amount" name="spend_amount" oninput="number_only(this)" value="<?php echo $spend_amount; ?>" oninput="number_only(this)" minLength="1" maxLength="6" required>
                                        ...
                                        <div class="col-12 col-md-3">
                                            ...
                                            <input type="hidden"  id="main_doc" name="main_doc" value="<?= $main_doc;?>">
                                        </div>
