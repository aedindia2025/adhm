...
function print_view()
	...
	function print_pdf(doc_file_name)
	{
		
		 onmouseover=window.open('../adhmAdmin/uploads/carrier_guidance/documents' + doc_file_name,'onmouseover', 'height=600,width=900,scrollbars=yes,resizable=no,left=200,top=150,toolbar=no,location=no,directories=no,status=no,menubar=no');
	}
	function print_excel(doc_file_name)
	{
		
		 onmouseover=window.open('../adhmAdmin/uploads/carrier_guidance/documents' + doc_file_name,'onmouseover', 'height=600,width=900,scrollbars=yes,resizable=no,left=200,top=150,toolbar=no,location=no,directories=no,status=no,menubar=no');
	}
	// function print_word(doc_file_name)
	// {
	// 	// alert("jii");
	// 	 onmouseover=window.open('../adhmAdmin/uploads/carrier_guidance/documents' + doc_file_name,'onmouseover', 'height=600,width=900,scrollbars=yes,resizable=no,left=200,top=150,toolbar=no,location=no,directories=no,status=no,menubar=no');
	// }
