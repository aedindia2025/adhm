...
$mysqli = new mysqli($host, $username, $password, $databasename);
                                    ...
                                    {
                                        $sql = "SELECT com_name as c_no,income_level as i_no,c_file_name FROM std_app_s5 WHERE s1_unique_id = ? LIMIT 1";
									...
									if ($result->status) {
										...
										if (count($res_array) == 0) {
											...
											foreach ($res_array as $key => $value) {
                                               ...
                                               }elseif(!empty($cert_no['c_file_name'])){
