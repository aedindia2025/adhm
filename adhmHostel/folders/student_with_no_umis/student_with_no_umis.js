...
var form_footer = '';
var table_name = '';
var table_id = 'students_with_no_umis_datatable';
...
function init_datatable(table_id = '', form_name = '', action = '') {
	...
	var ajax_url = "https://103.110.236.187/adhm/adhmHostel/folders/student_with_no_umis/crud.php";
		...
		buttons: [
			{
				...
				title: 'No of Students with no umis'
			},
			{
				extend: 'csvHtml5',
				exportOptions: {
