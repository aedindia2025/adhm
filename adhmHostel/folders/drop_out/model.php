...
$ses_academic_year = academic_year()[0]['unique_id'];
$ses_hostel_taluk = $_SESSION["hostel_taluk"];
$ses_taluk_id = $_SESSION['taluk_id'];

$drop_discontinue_date = date('Y-m-d');
...
if (isset($_GET["unique_id"])) {
    if (!empty($_GET["unique_id"])) {
        ...
        if ($result_values->status) {
            ...
            $cust_reason = $result_values[0]["cust_reason"];
...
<?php
$student_id_options = student_id($student_id, $_SESSION['hostel_id'], $student_list);
$student_id_options = select_option($student_id_options, 'Select Student ID', $student_id);

$dropout_reason_options = dropout_reason();
$dropout_reason_options = select_option($dropout_reason_options, 'Select Dropout Reason', $dropout_reason);
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-4 fm">
                                            <label for="staff_id" class="form-label">Staff Id:<span class="xy-lab"> <?= $ses_staff_id; ?></span></label>
                                        </div>
                                        <div class="col-md-4 fm">
                                    ...
                                    <input type="hidden"  id="csrf_token" name="csrf_token" value="<?php echo $_SESSION['csrf_token']; ?>">
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-md-3 fm">
                                                ...
                                                <input type="text" class="form-control" id="student_name"
                                                    name="student_name" placeholder="Student Name" readonly
                                            ...
                                            <div class="col-md-3 fm">
                                                ...
                                                <input type="date" class="form-control" id="drop_discontinue_date"
                                                    ...
                                                    value="<?= $drop_discontinue_date; ?>" required>
                                        ...
                                        <div class="col-md-3 fm">
                                                ...
                                                <select class="form-select" id="dropout_reason" name="dropout_reason"
                                                   onchange="get_cust_reason()" required>
                                                    <?php echo $dropout_reason_options; ?>
                                                </select>
                                            </div>

                                            <div class="col-md-3 mt-3 fm" style="display: none" id="cust_reason_div">
                                                <label for="reason" class="form-label">Reason</label>
                                                <textarea class="form-control" id="cust_reason" oninput="description_val(this)"
                                                    name="cust_reason"><?php echo $cust_reason; ?></textarea>
                                            </div>
