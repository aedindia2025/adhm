    ...
    if ($_GET["unique_id"]) {
        ...
        $columns = [
            ...
            "address",
            "unique_id",
            "(select student_status from std_app_s where unique_id =  $table.s1_unique_id )as student_status"
        ...
        $columns2    = [
            ...
            "(select student_status from std_app_s where unique_id =  $table2.s1_unique_id )as student_status"
        ...
        if ($result_values2->status) {
            ...
            $student_status        = $result_values2[0]["student_status"];
    ...
    <div class="card-body">
        ...
        <div class="row">
                        ...
                        <div class="col-sm-9">
                          ...
                          <div class="col-sm-3">
                            ...
                            <?php if ($student_status != '1') { ?>
                                <img src="<?php echo $image_src_adhaar; ?>" class=" avatar-xxl img-thumbnail-pdh-profile"
                                    alt="profile-image">
                            <?php } ?>
            ...
            <div class="col-sm-12 ">
                <div class="mt-0 float-sm-left">
                    <div class="row">
                        ...
                        <div class="col-sm-4 ">
                            <p class="font-12">Hostel District: <strong><?= $std_hostel_district; ?></strong></p>
                        </div>
                        <div class="col-sm-4 ">
                            <p class="font-12"> Hostel Taluk: <strong><?= $std_hostel_taluk; ?></strong></p>
                        </div>
                        <!-- <div class="col-sm-4">
                        ...
                        <div class="col-sm-4">
                            <p class="font-12">Hostel Name: <strong><?= $std_hostel_name; ?></strong></p>
                        </div>
                    </div>
                </div><!-- end col -->
            </div>
            ...
            <div class="col-sm-12 ">
                <div class="mt-0 float-sm-left">
                    <div class="row">
                        ...
                        <?php } ?>
                        <div class="col-sm-4 ">
                            <p class="font-12"> D.O.B: <strong><?= $student_dob_s6; ?></strong></p>
                        </div>
                        <div class="col-sm-4  ">
            ...
            <div class="col-sm-12 mb-3">
                <div class=" mt-4 vendorListHeading">
    ...
    <div class="col-sm-12 mb-2 ">
        <div class="mt-0 float-sm-left">
            ...
            <div class="row">
                ...
                <div class="col-sm-4">
                    ...
                    <?php } else if ($community_pdf) { ?>

                        <p class="font-12"> Community Certificate: <strong><a href="<?php echo $community_pdf; ?>"><img src="../../assets/images/pdf.png" width="50px" height="50px"></a></strong></p>

                    <?php } else { ?>
                        <p class="font-12"> Community Certificate: <strong><img src="../../../assets/images/no-preview.png" style="width:50px; height:50px"></strong></p>

                    <?php } ?>

                    <!-- <p class="font-12"> Community Certificate: <strong><a href="<?= $community_pdf; ?>"><img src="../../assets/images/pdf.png" width="30%" height="36%"></a></strong></p> -->
                </div>
        ...
        <div class=" mt-2 vendorListHeading">
            ...
            <div class="row mb-2">
                ...
                <?php if ($income_file) { ?>
                    <div class="col-sm-4">
                        <p class="font-12"> Income Certificate: <strong><?php echo $std_income_file; ?></strong></p>
                    </div>

                <?php } else if ($income_pdf) { ?>

                    <p class="font-12"> Income Certificate: <strong><a href="<?php echo $income_pdf; ?>"><img src="../../assets/images/pdf.png" style="width:50px; height:50px"></a></strong></p>

                <?php } else { ?>

                    <p class="font-12"> Income Certificate: <strong><img src="../../../assets/images/no-preview.png" style="width:50px; height:50px"></strong></p>
