        ...
        if ($result->status) {
            ...
            if (count($result->data) == '0') {
                ...
                for ($i = 1; $i <= $demos; ++$i) {
                    ...
                    if ($page == $i) {
                        $card_food .= "<a href='index.php?file=cctv_live/list&page={$ab}&name={$i}&district_name={$d}&taluk_name={$t}&hostel_name={$h}&academic_year={$ac}&data_limit={$lmt}' class='link active'>{$i}</a>";
                    } else {
                        $card_food .= "<a href='index.php?file=cctv_live/list&page={$ab}&name={$i}&district_name={$d}&taluk_name={$t}&hostel_name={$h}&academic_year={$ac}&data_limit={$lmt}' class='link'>{$i}</a>";
                    }
