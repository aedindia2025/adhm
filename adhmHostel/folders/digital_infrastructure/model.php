                                ...
                                <div id="basicwizard">
                                    ...
                                    <div class="tab-content b-0 mb-0">
                                            ...
                                            <div class="row">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-12 fm">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                value="<?php echo $_SESSION['taluk_name']; ?>" readonly>
                                                        </div>
                                                ...
                                                <div class="col-md-6 fm">
                                                    ...
                                                    <input class="form-control" id="district" name="district"
                                                        value="<?php echo $_SESSION['district_name']; ?>" readonly>
                                                </div>
                                        ...
                                        <div class="tab-pane" id="settings2">
                                            <div class="row">
                                                <div class="col-md-4 fm">
                                                    ...
                                                    <select name="facilities_type" id="facilities_type"
                                                        class="form-control" required onchange="get_asset_name()">
                                            ...
                                            <ul class="pager wizard mb-0 list-inline mt-1">
                                                <li class="previous list-inline-item mob-folt">
                                                    <button type="button" class="btn btn-info"><i
                                                            class="mdi mdi-arrow-left me-1"></i> Back
                                                    </button>
                                                </li>
                                                <li class="next list-inline-item float-end mob-lef">
