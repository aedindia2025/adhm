...
<div class=" overall-bg">
    ...
    <div class="row ">
        <div class="col-md-12 col-xl-7 col-sm-12">
            <img src="assets/images/hotel_header.png">
        </div>
        <div class="col-md-12 col-xl-4 col-sm-12 input-file text-center">
            <h3>Welcome</h3>
            <p>Login into Hostel Account</p>
            <form class="frm-to">
                <div class="mb-3">
            ...
            <button class="btn " onclick='login();' type="button" id="loginButton"> Log In </button>
...
<!--<div class="row">
<div class="col-md-5">
 <img src="assets/images/hostel-login.jpg" style="width:100%" /> 
</div>
...
<a href="index.php" class="back_home"><i class="mdi mdi-home"></i></a>
                        ...
                        <div class="card">
                            ...
                            <div class="card-header py-2 text-center bg-info">
                                <h4 style="color: #fff;font-weight: 600;font-size: 21px;">Hostel Login</h4>
                            </div>

                            <div class="card-body p-4 ">
                                
                                <center><img src="assets/images/ad-logo.png" alt="logo"  class="mb-4"></center>

                                <form action="#">

                                    <div class="mb-3">
                                        <label for="emailaddress" class="form-label">User Name</label>
                                <input id="user_name" type="text" class="form-control" name="user_name" tabindex="1" required="" placeholder="User Name" autofocus="">
                                    </div>
