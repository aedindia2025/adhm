...
"screen_unique_id",
    ...
    case 'createupdate_overall':
        ...
        $status = true;
        if ($unique_id) {
            $sql = "UPDATE $overall_table SET item_name = ?, qty = ?, screen_unique_id = ?, act_qty = ?, stock_id = ? WHERE unique_id = ?";
            $params = [$item_name, $consume_qty, $screen_unique_id, $act_qty, $stock_id, $unique_id];
            $types = "ssssss";
        } else {
            // Generate unique id (assuming unique_id($prefix) is a function to generate it)
            $generated_unique_id = unique_id($prefix);

            $sql = "INSERT INTO $overall_table (item_name, qty, screen_unique_id, act_qty, stock_id, unique_id) VALUES (?, ?, ?, ?, ?, ?)";
            $params = [$item_name, $consume_qty, $screen_unique_id, $act_qty, $stock_id, $generated_unique_id];
            $types = "ssssss";
        }
    ...
    case 'createupdate':
        ...
        $generated_unique_id = unique_id($prefix);
        $sql = "INSERT INTO $table (item_name, actual_qty, qty, stock_id, screen_unique_id,  unique_id) VALUES (?, ?, ?, ?, ?, ?)";
        $params = [$item_name, $act_qty, $consume_qty, $stock_id, $screen_unique_id, $generated_unique_id];
        $types = "ssssss";
