                                    ...
                                    <div class="tab-content b-0 mb-0">
                                        <div class="tab-pane active" id="basictab1">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="alert alert-info alert-border-left alert-dismissible fade show material-shadow" role="alert">
                                                        <div class="alert-content">
                                                            <p class="mb-0">2025-26 Direct Renewal Steps to be followed for each student</p>
                                                        </div>
                                                        <strong class="mb-2">Step 1 : </strong>Validation of Student Name as per Aadhar and EMIS/ UMIS
                                                        <br>
                                                        <strong class="mb-2">Step 2 : </strong>Validation of Student hostel-school/ college/ institute-home distance
                                                        <br>
                                                        <strong class="mb-2">Step 3 : </strong>Click on transfer/ Exit/ Renew as per action required for each student
                                                        <br>
                                                        <strong class="mb-2">Step 4 : </strong>Once completed for Direct Renewal tab, click on Go to Print for Dispatch
                                                        <br>
                                                        <strong class="mb-2">Step 5 : </strong>Prepare Print for Despatch to send for DADWO approval
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
                                            ...
                                            <div class="col-md-12 mt-3" align="right">
                                                <button type="button" id="autoRenewal" onclick="window.location.href='<?php echo $url; ?>'" class="btn btn-primary waves-effect waves-light">Go to Print For Dispatch</button>
                                            </div>
                                        </div>
                                        <div class="tab-pane" id="basictab2">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="alert alert-info alert-border-left alert-dismissible fade show material-shadow" role="alert">
                                                        <div class="alert-content">
                                                            <p class="mb-0">2025-26 Exception Renewal Steps to be followed for each student</p>
                                                        </div>
                                                        <strong class="mb-2">Step 1 : </strong>Validation of Student Name as per Aadhar and EMIS/ UMIS
                                                        <br>
                                                        <strong class="mb-2">Step 2 : </strong>Validation of Student hostel-school/ college/ institute-home distance
                                                        ...
                                                        <strong class="mb-2">Step 3 : </strong>Click on transfer/ Exit/ Renew as per action required for each student
                                                        <br>
                                                        <strong class="mb-2">Step 4 : </strong>Raise request for Exception Renewal processing of identified students
                                                        <br>
                                                        <strong class="mb-2">Step 5 : </strong>DADWO to verify in the hostel and approve with report
                                                        <br>
                                                        <strong class="mb-2">Step 6 : </strong>Once completed processed on Exception Renewal tab, click on Go to Print for Dispatch
                                                        <br>
                                                        <strong class="mb-2">Step 7 : </strong>Prepare Print for Despatch to send for DADWO approval
                                                    </div>
                                                </div>
                                            </div>
                                            <div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="was-validated" autocomplete="off">
                    <div class="row">
                        <input type="hidden" class="form-control" id="fromDistrict" name="fromDistrict" value="<?= $_SESSION['district_id']; ?>">
                        <input type="hidden" class="form-control" id="fromTaluk" name="fromTaluk" value="<?= $_SESSION['taluk_id']; ?>">
                        <input type="hidden" class="form-control" id="fromHostel" name="fromHostel" value="<?= $_SESSION['hostel_id']; ?>">
                        <input type="hidden" class="form-control" id="s1UniqueId" name="s1UniqueId">
                        <input type="hidden" class="form-control" id="gender_id" name="gender_id" value="<?= $_SESSION['gender_id']; ?>">
                        <input type="hidden" class="form-control" id="hostel_type_id" name="hostel_type_id" value="<?= $_SESSION['hostel_type']; ?>">
                        <div class="col-md-4">
                            <div class="mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="select2 form-control" id="district_id"
                                    name="district_id" onchange="get_taluk_id()" required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="select2 form-control" id="taluk_id"
                                    name="taluk_id" onchange="get_hostel_id()" required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="select2 form-control" id="hostelId"
                                    name="hostelId" required>
            ...
            <div class="modal-footer justify-content-center border-0">
                <button type="button" id="transferBtn" class="btn btn-primary"
                    onclick="transferStd()">Transfer</button>
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="empty_fields()">Cancel</button>
...
<!--Auto UMIS Modal -->
<div class="modal fade" id="umisModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    ...
    <div class="modal-dialog modal-dialog-centered modal-l" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="was-validated" autocomplete="off">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="alert alert-info alert-border-left alert-dismissible fade show material-shadow" role="alert">
                                மாணவன் விடுதியில் ஒரு ஆண்டிற்கும் மேலாக தங்கியுள்ளதால், பயிலும் கல்லூரியில் வழங்கப்பட்ட UMIS எண்ணை பதிவு செய்யவும். | Since the student has been studying in the hostel for more than a year, UMIS number would be generated in College/ Institute. Please update to process renewal.
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="umis_number" name="umis_number" required minlength="12" maxlength="12" oninput="number_only(this)">
                            </div>
                        </div>
                    </div>
                </form>
            ...
            <div class="modal-footer justify-content-center border-0">
                <button type="button" id="umisInsertBtn" class="btn btn-primary"
                    onclick="submitUMIS()">Submit</button>
...
<div class="modal fade" id="m_transferModal" tabindex="-1" role="dialog" aria-labelledby="m_transferModalLabel" aria-hidden="true">
    <div class="modal-dialog  modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form class="was-validated" autocomplete="off">
                    <div class="row">
                        <input type="hidden" class="form-control" id="m_fromDistrict" name="m_fromDistrict" value="<?= $_SESSION['district_id']; ?>">
                        <input type="hidden" class="form-control" id="m_fromTaluk" name="m_fromTaluk" value="<?= $_SESSION['taluk_id']; ?>">
                        <input type="hidden" class="form-control" id="m_fromHostel" name="m_fromHostel" value="<?= $_SESSION['hostel_id']; ?>">
                        <input type="hidden" class="form-control" id="m_s1UniqueId" name="m_s1UniqueId">
                        <input type="hidden" class="form-control" id="m_gender_id" name="m_gender_id" value="<?= $_SESSION['gender_id']; ?>">
                        <input type="hidden" class="form-control" id="m_hostel_type_id" name="m_hostel_type_id" value="<?= $_SESSION['hostel_type']; ?>">
                        <div class="col-md-4">
                            <div class="mb-3">
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="m_studentName" name="m_studentName" required readonly>
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="mb-3">
                                <label class="form-label" for="m_district_id">Transfer District</label>
                                <select class="select2 form-control" id="m_district_id"
                                    name="m_district_id" onchange="m_get_taluk_id()" required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="select2 form-control" id="m_taluk_id"
                                    name="m_taluk_id" onchange="m_get_hostel_id()" required>
                        ...
                        <div class="col-md-4">
                            <div class="mb-3">
                                ...
                                <select class="select2 form-control" id="m_hostelId"
                                    name="m_hostelId" required>
            ...
            <div class="modal-footer justify-content-center border-0">
                ...
                <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" onclick="m_empty_fields()">Cancel</button>
...
<!--Manual UMIS Modal -->
<div class="modal fade" id="m_umisModal" tabindex="-1" role="dialog" aria-labelledby="modalLabel"
    aria-hidden="true" data-backdrop="static" data-keyboard="false">
    <div class="modal-dialog modal-dialog-centered modal-l" role="document">
        <div class="modal-content">
            <div class="modal-header border-0">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="m_umis_number" name="m_umis_number" required minlength="12" maxlength="12" oninput="number_only(this)">
                            </div>
                        </div>
                    </div>
                </form>
