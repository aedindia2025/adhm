...
<head>
    ...
    header('Access-Control-Allow-Origin: https://103.186.220.140');
    ...
    <link href="assets/libs/select2-bootstrap4/select2-bootstrap4.css" rel="stylesheet" type="text/css" />

    <!-- Dropify -->
    <link href="assets/libs/dropify/dist/css/dropify.min.css" rel="stylesheet" type="text/css" />
    <!-- jQuery Multiselect -->
    <link href="assets/libs/jquery_multiselect/jquery.multiselect.css" rel="stylesheet" type="text/css" />
...
<body>
    ...
    <div class="wrapper">
                ...
                <ul class="topbar-menu d-flex align-items-center gap-3">
                    ...
                    <!-- <li>
                        <div class="page-title-right">
                            <a href="index.php?file=dashboard/hostel-info"> <button class="btn btn-info" style="float: right;">Hostel Info</button></a>
                        </div>
                    </li> -->
                    <li class="dropdown">
                        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#"
                            ...
                            <span class="account-user-avatar">
                                ...
                                if ($_SESSION['staff_image'] != '') {
                                    ...
                                    echo '<img src="../../../adhmAdmin/uploads/staff_registration/' . $_SESSION['staff_image'] . '" alt="user-image" width="32" class="rounded-circle">';
                                } else {
                                    // If $_SESSION['staff_image'] is not set or empty, display the commented code
                                    echo ' <img src="assets/images/users/avatar-1.jpg" alt="user-image" width="32" class="rounded-circle">';
                                }
                                ?>
                            </span>
                        ...
                        <div class="dropdown-menu dropdown-menu-end dropdown-menu-animated profile-dropdown">
                            ...
                            <a href="#" data-bs-toggle="modal" data-bs-target=".bs-example-modal-xl"
                                class="dropdown-item">
            ...
            <div class="h-100" id="leftside-menu-container" data-simplebar>
                ...
                <div class="card text-center pro-mar">
                    <div class="card-body red-pad">
                        ...
                        if ($_SESSION['staff_image'] != '') {
                            // If $_SESSION['staff_image'] is set and not empty, display the image
                            echo '<img src="../../../adhmAdmin/uploads/staff_registration/' . $_SESSION['staff_image'] . '" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">';
                        } else {
                            // If $_SESSION['staff_image'] is not set or empty, display the commented code
                            echo '<img src="assets/images/users/avatar-1.jpg" class="rounded-circle avatar-lg img-thumbnail" alt="profile-image">';
                        }
                        ?>
                        ...
                        <div class="text-start n-colo mt-1">
                            ...
                            <p class=" mb-1 font-13"><i class="ri-user-follow-fill"></i><span class="ms-2">
                                    <?php echo $_SESSION['staff_name']; ?>(<?php echo $_SESSION['designation_name']; ?>)
                                </span></p>
                            <p class=" mb-1 font-13"><i class="ri-cellphone-line"></i><span class="ms-2">
                                    <?php echo $_SESSION['mobile_num']; ?>
                                </span></p>

                            <p class="mb-1 font-13"><i class="uil-envelope"></i> <span class="ms-2 ">
                                    <?php echo $_SESSION['email_id']; ?>
                                </span></p>

                            <p class=" mb-0 font-13"><i class="ri-user-location-line"> </i><span class="ms-2">
                                    <?php echo $_SESSION['hostel_main_id']; ?> - <?php echo $_SESSION['hostel_name']; ?>
                                </span></p>
                        </div>
        ...
        <div class="modal fade bs-example-modal-xl" id="mymodel" data-bs-backdrop="static" data-bs-keyboard="false"
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-10">
                                    <div class="mb-2">
                                        ...
                                        <div class="mb-4 mt-3 hidden" id="new_password_section">
    ...
    <!-- jsPDF AutoTable (patches jsPDF) -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jspdf-autotable/3.5.28/jspdf.plugin.autotable.min.js"></script>

    <!-- Tamil font (after jsPDF + AutoTable are ready) -->
    <script src="../../assets/js/fonts/NotoSansTamil-Regular.js"></script>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        try {
                            ...
                            var server_password = obj.password_old;
