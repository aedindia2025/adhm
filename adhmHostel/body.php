      ...
      <div class="main-content">
        <?php 
          ...
          if (isset($_GET['file'])) { 
            ...
            $file_name_model       = base64_encode(openssl_encrypt($menu_screen, $enc_method, $enc_password, OPENSSL_RAW_DATA, $enc_iv));
            $add_btn_link    = "index.php?file=".$file_name_model;
            ...
            $file_name_create       = base64_encode(openssl_encrypt($menu_screen, $enc_method, $enc_password, OPENSSL_RAW_DATA, $enc_iv));
            $btn_save      = "index.php?file=".$file_name_create;
          ?>
            <script>
